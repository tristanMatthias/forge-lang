...
define i64 @pick_first__int__int(i64 %0, i64 %1) {
entry:
...
entry:
  ...
  %1 = call i64 @identity__int(i64 42)
  ...
  %5 = call i64 @pick_first__int__int(i64 10, i64 20)
  ...
  %9 = call ptr @wrap__string(ptr @.str)
