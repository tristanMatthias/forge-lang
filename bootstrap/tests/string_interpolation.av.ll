...
@.str.6 = private unnamed_addr constant [18 x i8] c"nested: [1, 2, 3]\00", align 1
...
entry:
  ...
  %concat_total5 = add i64 %9, %10
  %concat_size6 = add i64 %concat_total5, 1
  %11 = call ptr @avra_rc_alloc(i64 %concat_size6)
  %12 = call ptr @memcpy(ptr %11, ptr %7, i64 %9)
  %cast7 = ptrtoint ptr %11 to i64
  %dst2_int8 = add i64 %cast7, %9
  %cast9 = inttoptr i64 %dst2_int8 to ptr
  %rhs_len_p110 = add i64 %10, 1
  %13 = call ptr @memcpy(ptr %cast9, ptr @.str.2, i64 %rhs_len_p110)
  %b11 = load i64, ptr %b, align 8
  %14 = call ptr @avra_rc_alloc(i64 32)
  %15 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %14, i64 32, ptr @.i2s_fmt.3, i64 %b11)
  %widen12 = sext i32 %15 to i64
  %16 = call i64 @strlen(ptr %11)
  %17 = call i64 @strlen(ptr %14)
  %concat_total13 = add i64 %16, %17
  %concat_size14 = add i64 %concat_total13, 1
  %18 = call ptr @avra_rc_alloc(i64 %concat_size14)
  %19 = call ptr @memcpy(ptr %18, ptr %11, i64 %16)
  %cast15 = ptrtoint ptr %18 to i64
  %dst2_int16 = add i64 %cast15, %16
  %cast17 = inttoptr i64 %dst2_int16 to ptr
  %rhs_len_p118 = add i64 %17, 1
  %20 = call ptr @memcpy(ptr %cast17, ptr %14, i64 %rhs_len_p118)
  %21 = call i64 @strlen(ptr %18)
  %22 = call i64 @strlen(ptr @.str.4)
  %concat_total19 = add i64 %21, %22
  %concat_size20 = add i64 %concat_total19, 1
  %23 = call ptr @avra_rc_alloc(i64 %concat_size20)
  %24 = call ptr @memcpy(ptr %23, ptr %18, i64 %21)
  %cast21 = ptrtoint ptr %23 to i64
  %dst2_int22 = add i64 %cast21, %21
  %cast23 = inttoptr i64 %dst2_int22 to ptr
  %rhs_len_p124 = add i64 %22, 1
  %25 = call ptr @memcpy(ptr %cast23, ptr @.str.4, i64 %rhs_len_p124)
  %a25 = load i64, ptr %a, align 8
  %b26 = load i64, ptr %b, align 8
  %add = add i64 %a25, %b26
  %26 = call ptr @avra_rc_alloc(i64 32)
  %27 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %26, i64 32, ptr @.i2s_fmt.5, i64 %add)
  %widen27 = sext i32 %27 to i64
  %28 = call i64 @strlen(ptr %23)
  %29 = call i64 @strlen(ptr %26)
  %concat_total28 = add i64 %28, %29
  %concat_size29 = add i64 %concat_total28, 1
  %30 = call ptr @avra_rc_alloc(i64 %concat_size29)
  %31 = call ptr @memcpy(ptr %30, ptr %23, i64 %28)
  %cast30 = ptrtoint ptr %30 to i64
  %dst2_int31 = add i64 %cast30, %28
  %cast32 = inttoptr i64 %dst2_int31 to ptr
  %rhs_len_p133 = add i64 %29, 1
  %32 = call ptr @memcpy(ptr %cast32, ptr %26, i64 %rhs_len_p133)
  %33 = call i32 @puts(ptr %30)
  %widen34 = sext i32 %33 to i64
  %34 = call i32 @puts(ptr @.str.6)
