...
@src_file = private unnamed_addr constant [107 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/generic_struct_field.av\00", align 1
...
entry:
  ...
  %2 = call ptr @unwrap__Box(ptr %b2)
  store ptr %2, ptr %result, align 8
  %result3 = load ptr, ptr %result, align 8
  %cast4 = ptrtoint ptr %result3 to i64
  %null_chk = icmp eq i64 %cast4, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name, i64 5, ptr @sty_name, i64 3, i64 %null_ext, ptr @src_file, i64 106, i64 10)
  %value_ptr = getelementptr inbounds nuw %Box, ptr %result3, i32 0, i32 0
  %value = load ptr, ptr %value_ptr, align 8
  %3 = call i32 @puts(ptr %value)
...
do_free:                                          ; preds = %entry
  %rel_value_ptr = getelementptr inbounds nuw %Box, ptr %0, i32 0, i32 0
