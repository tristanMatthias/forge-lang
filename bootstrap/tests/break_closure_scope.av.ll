...
entry:
  ...
  %inc3 = load i64, ptr @inc, align 8
  %cast4 = inttoptr i64 %inc3 to ptr
  %5 = call i64 @avra_array_get(ptr %cast4, i64 1)
  %fn_ptr5 = inttoptr i64 %5 to ptr
  %closure_call6 = call i64 %fn_ptr5()
  ...
  %counter = load i64, ptr @counter, align 8
  %9 = call ptr @avra_rc_alloc(i64 32)
  %10 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %9, i64 32, ptr @.i2s_fmt.2, i64 %counter)
