...
entry:
  ...
  %sle = icmp sle i64 %a15, %b16
  %sle_ext = zext i1 %sle to i64
  %12 = call ptr @avra_rc_alloc(i64 32)
  %13 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %12, i64 32, ptr @.i2s_fmt.4, i64 %sle_ext)
  %widen17 = sext i32 %13 to i64
  %14 = call i32 @puts(ptr %12)
  %widen18 = sext i32 %14 to i64
  %a19 = load i64, ptr @a, align 8
  %b20 = load i64, ptr @b, align 8
  %sgt = icmp sgt i64 %a19, %b20
  %sgt_ext = zext i1 %sgt to i64
  %15 = call ptr @avra_rc_alloc(i64 32)
  %16 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %15, i64 32, ptr @.i2s_fmt.5, i64 %sgt_ext)
  ...
  %sge = icmp sge i64 %a23, %b24
  %sge_ext = zext i1 %sge to i64
  %18 = call ptr @avra_rc_alloc(i64 32)
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt.6, i64 %sge_ext)
  %widen25 = sext i32 %19 to i64
  %20 = call i32 @puts(ptr %18)
  %widen26 = sext i32 %20 to i64
  %a27 = load i64, ptr @a, align 8
  %sle28 = icmp sle i64 %a27, 10
  %sle_ext29 = zext i1 %sle28 to i64
  %21 = call ptr @avra_rc_alloc(i64 32)
  %22 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %21, i64 32, ptr @.i2s_fmt.7, i64 %sle_ext29)
  %widen30 = sext i32 %22 to i64
  %23 = call i32 @puts(ptr %21)
  %widen31 = sext i32 %23 to i64
  %a32 = load i64, ptr @a, align 8
  %sge33 = icmp sge i64 %a32, 10
  %sge_ext34 = zext i1 %sge33 to i64
  %24 = call ptr @avra_rc_alloc(i64 32)
  %25 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %24, i64 32, ptr @.i2s_fmt.8, i64 %sge_ext34)
  %widen35 = sext i32 %25 to i64
  %26 = call i32 @puts(ptr %24)
  %widen36 = sext i32 %26 to i64
  %27 = call i32 @strcmp(ptr @.str, ptr @.str.9)
  %widen37 = sext i32 %27 to i64
  %streq_cmp = icmp eq i64 %widen37, 0
  %streq_ext = zext i1 %streq_cmp to i64
  %28 = call ptr @avra_rc_alloc(i64 32)
  %29 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %28, i64 32, ptr @.i2s_fmt.10, i64 %streq_ext)
  %widen38 = sext i32 %29 to i64
  %30 = call i32 @puts(ptr %28)
  %widen39 = sext i32 %30 to i64
  %31 = call i32 @strcmp(ptr @.str.11, ptr @.str.12)
  %widen40 = sext i32 %31 to i64
  %streq_cmp41 = icmp ne i64 %widen40, 0
  %streq_ext42 = zext i1 %streq_cmp41 to i64
  %32 = call ptr @avra_rc_alloc(i64 32)
  %33 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %32, i64 32, ptr @.i2s_fmt.13, i64 %streq_ext42)
  %widen43 = sext i32 %33 to i64
  %34 = call i32 @puts(ptr %32)
  %widen44 = sext i32 %34 to i64
  %35 = call i32 @strcmp(ptr @.str.14, ptr @.str.15)
  %widen45 = sext i32 %35 to i64
  %scmp_cmp = icmp slt i64 %widen45, 0
  %scmp_ext = zext i1 %scmp_cmp to i64
  %36 = call ptr @avra_rc_alloc(i64 32)
  %37 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %36, i64 32, ptr @.i2s_fmt.16, i64 %scmp_ext)
  %widen46 = sext i32 %37 to i64
  %38 = call i32 @puts(ptr %36)
  %widen47 = sext i32 %38 to i64
  %39 = call i32 @avra_test_summary()
  %widen48 = sext i32 %39 to i64
