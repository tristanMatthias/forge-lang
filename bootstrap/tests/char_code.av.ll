...
@.str.8 = private unnamed_addr constant [10 x i8] c"uppercase\00", align 1
@.str.9 = private unnamed_addr constant [14 x i8] c"not uppercase\00", align 1
...
define i64 @main() {
entry:
  %char_byte = load i8, ptr @.str, align 8
  %char_code = zext i8 %char_byte to i64
  %0 = call ptr @avra_rc_alloc(i64 32)
  %1 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %0, i64 32, ptr @.i2s_fmt, i64 %char_code)
  %widen = sext i32 %1 to i64
  %2 = call i32 @puts(ptr %0)
  %widen1 = sext i32 %2 to i64
  %char_byte2 = load i8, ptr @.str.1, align 8
  %char_code3 = zext i8 %char_byte2 to i64
  %3 = call ptr @avra_rc_alloc(i64 32)
  %4 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %3, i64 32, ptr @.i2s_fmt.2, i64 %char_code3)
  %widen4 = sext i32 %4 to i64
  %5 = call i32 @puts(ptr %3)
  %widen5 = sext i32 %5 to i64
  %char_byte6 = load i8, ptr @.str.3, align 8
  %char_code7 = zext i8 %char_byte6 to i64
  %6 = call ptr @avra_rc_alloc(i64 32)
  %7 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %6, i64 32, ptr @.i2s_fmt.4, i64 %char_code7)
  %widen8 = sext i32 %7 to i64
  %8 = call i32 @puts(ptr %6)
  %widen9 = sext i32 %8 to i64
  %char_byte10 = load i8, ptr @.str.5, align 8
  %char_code11 = zext i8 %char_byte10 to i64
  %9 = call ptr @avra_rc_alloc(i64 32)
  %10 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %9, i64 32, ptr @.i2s_fmt.6, i64 %char_code11)
  %widen12 = sext i32 %10 to i64
  %11 = call i32 @puts(ptr %9)
  %widen13 = sext i32 %11 to i64
  store ptr @.str.7, ptr @ch, align 8
  %ch = load ptr, ptr @ch, align 8
  %char_byte14 = load i8, ptr %ch, align 8
  %char_code15 = zext i8 %char_byte14 to i64
  %sge = icmp sge i64 %char_code15, 65
...
sc_rhs:                                           ; preds = %entry
  ...
  %char_byte17 = load i8, ptr %ch16, align 8
  %char_code18 = zext i8 %char_byte17 to i64
  %sle = icmp sle i64 %char_code18, 90
...
if_then:                                          ; preds = %sc_merge
  %13 = call i32 @puts(ptr @.str.8)
  %widen19 = sext i32 %13 to i64
  br label %ifcont

if_else:                                          ; preds = %sc_merge
  %14 = call i32 @puts(ptr @.str.9)
