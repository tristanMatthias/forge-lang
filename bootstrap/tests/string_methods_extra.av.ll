...
entry:
  ...
  %1 = call ptr @avra_str_repeat(ptr @.str, i64 3)
  %2 = call i32 @puts(ptr %1)
  %widen = sext i32 %2 to i64
  %3 = call ptr @avra_str_repeat(ptr @.str.1, i64 10)
  %4 = call i32 @puts(ptr %3)
  %widen1 = sext i32 %4 to i64
  %5 = call ptr @avra_str_reverse(ptr @.str.2)
  %6 = call i32 @puts(ptr %5)
  %widen2 = sext i32 %6 to i64
  %7 = call ptr @avra_str_reverse(ptr @.str.3)
