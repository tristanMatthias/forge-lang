...
define ptr @math_box_new(ptr %0) {
entry:
  %name = alloca ptr, align 8
  store ptr %0, ptr %name, align 8
  %1 = call ptr @avra_rc_alloc(i64 16)
  %name1 = load ptr, ptr %name, align 8
  %fld_ptr = getelementptr inbounds nuw %Math_box, ptr %1, i32 0, i32 0
  store ptr %name1, ptr %fld_ptr, align 8
  %fld_ptr2 = getelementptr inbounds nuw %Math_box, ptr %1, i32 0, i32 1
...
define i64 @math_box_double(i64 %0) {
entry:
...
define i64 @math_box_triple(i64 %0) {
entry:
  %x = alloca i64, align 8
  store i64 %0, ptr %x, align 8
  %x1 = load i64, ptr %x, align 8
...
entry:
  ...
  %1 = call i64 @math_box_double(i64 5)
  ...
  %5 = call i64 @math_box_triple(i64 5)
  %6 = call i64 @math_box_double(i64 5)
  %add = add i64 %5, %6
  %sub = sub i64 %add, 5
  %7 = call ptr @avra_rc_alloc(i64 32)
  %8 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %7, i64 32, ptr @.i2s_fmt.1, i64 %sub)
...
define i64 @__release_Math_box(ptr %0) {
entry:
...
do_free:                                          ; preds = %entry
  %rel_name_ptr = getelementptr inbounds nuw %Math_box, ptr %0, i32 0, i32 0
