...
@.str.7 = private unnamed_addr constant [11 x i8] c"max_errors\00", align 1
...
declare ptr @avra_toml_get_string.1(ptr, ptr)

declare i64 @avra_toml_get_int.2(ptr, ptr)

declare i1 @avra_toml_get_bool.3(ptr, ptr)
...
entry:
  ...
  %1 = call i64 @avra_toml_get_string(ptr %config1, i64 ptrtoint (ptr @.str.4 to i64))
  %cast = inttoptr i64 %1 to ptr
  %2 = call i32 @puts(ptr %cast)
  %widen = sext i32 %2 to i64
  %config2 = load ptr, ptr %config, align 8
  %3 = call i64 @avra_toml_get_string(ptr %config2, i64 ptrtoint (ptr @.str.5 to i64))
  %cast3 = inttoptr i64 %3 to ptr
  %4 = call i32 @puts(ptr %cast3)
  %widen4 = sext i32 %4 to i64
  %config5 = load ptr, ptr %config, align 8
  %5 = call i64 @avra_toml_get_bool(ptr %config5, i64 ptrtoint (ptr @.str.6 to i64))
  ...
  %9 = call i64 @avra_toml_get_int(ptr %config8, i64 ptrtoint (ptr @.str.7 to i64))
