...
forin.body:                                       ; preds = %forin.cond
  %3 = call i64 @avra_array_get(ptr %items1, i64 %forin_i_val)
  store i64 %3, ptr %x, align 8
  %x2 = load i64, ptr %x, align 8
  %4 = call ptr @avra_rc_alloc(i64 32)
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt, i64 %x2)
...
forin.exit:                                       ; preds = %forin.cond
  ...
  store i64 6, ptr %for_end, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.incr, %forin.exit
