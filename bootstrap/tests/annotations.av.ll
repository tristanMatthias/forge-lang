...
@.str.1 = private unnamed_addr constant [4 x i8] c"hi \00", align 1
...
@src_file = private unnamed_addr constant [98 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/annotations.av\00", align 1
@fld_name.5 = private unnamed_addr constant [3 x i8] c"id\00", align 1
@sty_name.6 = private unnamed_addr constant [5 x i8] c"User\00", align 1
@src_file.7 = private unnamed_addr constant [98 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/annotations.av\00", align 1
...
entry:
  ...
  %1 = call ptr @greet(ptr @.str.2)
  %2 = call i32 @puts(ptr %1)
  %widen = sext i32 %2 to i64
  %3 = call ptr @greet_old(ptr @.str.3)
  %4 = call i32 @puts(ptr %3)
  %widen1 = sext i32 %4 to i64
  %5 = call ptr @avra_rc_alloc(i64 16)
  %fld_ptr = getelementptr inbounds nuw %User, ptr %5, i32 0, i32 0
  store i64 1, ptr %fld_ptr, align 8
  %fld_ptr2 = getelementptr inbounds nuw %User, ptr %5, i32 0, i32 1
  store ptr @.str.4, ptr %fld_ptr2, align 8
  %cast = ptrtoint ptr %5 to i64
  %cast3 = inttoptr i64 %cast to ptr
  store ptr %cast3, ptr %u, align 8
  %u4 = load ptr, ptr %u, align 8
  %cast5 = ptrtoint ptr %u4 to i64
  %null_chk = icmp eq i64 %cast5, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name, i64 4, ptr @sty_name, i64 4, i64 %null_ext, ptr @src_file, i64 97, i64 24)
  %name_ptr = getelementptr inbounds nuw %User, ptr %u4, i32 0, i32 1
  %name = load ptr, ptr %name_ptr, align 8
  %6 = call i32 @puts(ptr %name)
  %widen6 = sext i32 %6 to i64
  %u7 = load ptr, ptr %u, align 8
  %cast8 = ptrtoint ptr %u7 to i64
  %null_chk9 = icmp eq i64 %cast8, 0
  %null_ext10 = zext i1 %null_chk9 to i64
  call void @avra_null_deref_trap(ptr @fld_name.5, i64 2, ptr @sty_name.6, i64 4, i64 %null_ext10, ptr @src_file.7, i64 97, i64 25)
  %id_ptr = getelementptr inbounds nuw %User, ptr %u7, i32 0, i32 0
  %id = load i64, ptr %id_ptr, align 8
  %7 = call ptr @avra_rc_alloc(i64 32)
  %8 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %7, i64 32, ptr @.i2s_fmt, i64 %id)
  %widen11 = sext i32 %8 to i64
  %9 = call i32 @puts(ptr %7)
  %widen12 = sext i32 %9 to i64
  %u_cleanup = load ptr, ptr %u, align 8
  %10 = call i64 @__release_User(ptr %u_cleanup)
  ret i64 0
}
