...
@.str.1 = private unnamed_addr constant [5 x i8] c"avra\00", align 1
...
define i64 @"helpers::helper_add"(i64 %0, i64 %1) {
entry:
...
define ptr @"helpers::helper_greet"(ptr %0) {
entry:
...
entry:
  ...
  %1 = call i64 @"helpers::helper_add"(i64 3, i64 7)
  ...
  %5 = call ptr @"helpers::helper_greet"(ptr @.str.1)
