...
bb0:
  ...
  %1 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %0, i64 32, ptr @0, i64 -42)
  %2 = ptrtoint ptr %0 to i64
  %3 = inttoptr i64 %2 to ptr
  %4 = call i32 @puts(ptr %3)
  %5 = call ptr @malloc(i64 32)
  %6 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %5, i64 32, ptr @1, i64 10)
  %7 = ptrtoint ptr %5 to i64
  %8 = inttoptr i64 %7 to ptr
  %9 = call i32 @puts(ptr %8)
  %10 = call ptr @malloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @2, i64 1)
  %12 = ptrtoint ptr %10 to i64
  %13 = inttoptr i64 %12 to ptr
  %14 = call i32 @puts(ptr %13)
  %15 = call ptr @malloc(i64 32)
  %16 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %15, i64 32, ptr @3, i64 0)
  %17 = ptrtoint ptr %15 to i64
  %18 = inttoptr i64 %17 to ptr
  %19 = call i32 @puts(ptr %18)
  %20 = call ptr @malloc(i64 32)
  %21 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %20, i64 32, ptr @4, i64 0)
  %22 = ptrtoint ptr %20 to i64
  %23 = inttoptr i64 %22 to ptr
  %24 = call i32 @puts(ptr %23)
  %25 = call ptr @malloc(i64 32)
  %26 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %25, i64 32, ptr @5, i64 1)
  %27 = ptrtoint ptr %25 to i64
  %28 = inttoptr i64 %27 to ptr
  %29 = call i32 @puts(ptr %28)
  %30 = call ptr @malloc(i64 32)
  %31 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %30, i64 32, ptr @6, i64 5)
  %32 = ptrtoint ptr %30 to i64
  %33 = inttoptr i64 %32 to ptr
  %34 = call i32 @puts(ptr %33)
  %35 = call ptr @malloc(i64 32)
  %36 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %35, i64 32, ptr @7, i64 -15)
