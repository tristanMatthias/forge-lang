...
@.str.2 = private unnamed_addr constant [5 x i8] c"Avra\00", align 1
...
@dz_file = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/edge_method_chain.av\00", align 1
...
entry:
  ...
  %16 = call i64 @avra_str_ends_with(ptr %result10, ptr @.str.7)
  ...
  call void @avra_array_push(ptr %20, i64 9)
  call void @avra_array_push(ptr %20, i64 10)
  store ptr %20, ptr @nums, align 8
  ...
  %22 = call ptr @avra_array_filter(ptr %nums, i64 %cast)
  %23 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %23, i64 -559038737)
  call void @avra_array_push(ptr %23, i64 ptrtoint (ptr @__lambda_1 to i64))
  %cast13 = ptrtoint ptr %23 to i64
  %24 = call ptr @avra_array_map(ptr %22, i64 %cast13)
  %25 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %25, i64 -559038737)
  call void @avra_array_push(ptr %25, i64 ptrtoint (ptr @__lambda_2 to i64))
  %cast14 = ptrtoint ptr %25 to i64
  %26 = call i64 @avra_array_reduce(ptr %24, i64 0, i64 %cast14)
  store i64 %26, ptr @result2, align 8
  %result2 = load i64, ptr @result2, align 8
  %27 = call ptr @avra_rc_alloc(i64 32)
  %28 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %27, i64 32, ptr @.i2s_fmt.9, i64 %result2)
...
entry:
  ...
  call void @avra_div_by_zero_trap(i64 0, ptr @dz_file, i64 103, i64 11)
  %mod = srem i64 %x1, 2
