...
entry:
  ...
  call void @avra_array_push(ptr %0, i64 6)
  call void @avra_array_push(ptr %0, i64 7)
  call void @avra_array_push(ptr %0, i64 8)
  call void @avra_array_push(ptr %0, i64 9)
  ...
  %2 = call ptr @avra_array_filter(ptr %nums, i64 %cast)
  ...
  %4 = call ptr @avra_array_map(ptr %2, i64 %cast1)
  store ptr %4, ptr @result, align 8
  %result = load ptr, ptr @result, align 8
  %5 = call i64 @avra_array_get(ptr %result, i64 0)
  ...
  %9 = call i64 @avra_array_get(ptr %result3, i64 1)
  ...
  %13 = call i64 @avra_array_len(ptr %result6)
  ...
  call void @avra_array_foreach(ptr %nums9, i64 %cast10)
  %sum = load i64, ptr @sum, align 8
  %18 = call ptr @avra_rc_alloc(i64 32)
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt.3, i64 %sum)
  ...
  %22 = call ptr @avra_array_map(ptr %nums13, i64 %cast14)
  %23 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %23, i64 -559038737)
  call void @avra_array_push(ptr %23, i64 ptrtoint (ptr @__lambda_4 to i64))
  %cast15 = ptrtoint ptr %23 to i64
  %24 = call ptr @avra_array_filter(ptr %22, i64 %cast15)
  store ptr %24, ptr @mixed, align 8
  %mixed = load ptr, ptr @mixed, align 8
  %25 = call i64 @avra_array_get(ptr %mixed, i64 0)
  %26 = call ptr @avra_rc_alloc(i64 32)
  %27 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %26, i64 32, ptr @.i2s_fmt.4, i64 %25)
  %widen16 = sext i32 %27 to i64
  %28 = call i32 @puts(ptr %26)
  %widen17 = sext i32 %28 to i64
  %mixed18 = load ptr, ptr @mixed, align 8
  %29 = call i64 @avra_array_len(ptr %mixed18)
  %30 = call ptr @avra_rc_alloc(i64 32)
  %31 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %30, i64 32, ptr @.i2s_fmt.5, i64 %29)
  %widen19 = sext i32 %31 to i64
  %32 = call i32 @puts(ptr %30)
  %widen20 = sext i32 %32 to i64
  store i64 0, ptr @total, align 8
  %33 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %33, i64 10)
  call void @avra_array_push(ptr %33, i64 20)
  call void @avra_array_push(ptr %33, i64 30)
  %34 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %34, i64 -559038737)
  call void @avra_array_push(ptr %34, i64 ptrtoint (ptr @__lambda_5 to i64))
  %cast21 = ptrtoint ptr %34 to i64
  call void @avra_array_foreach(ptr %33, i64 %cast21)
  %total = load i64, ptr @total, align 8
  %35 = call ptr @avra_rc_alloc(i64 32)
  %36 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %35, i64 32, ptr @.i2s_fmt.6, i64 %total)
  %widen22 = sext i32 %36 to i64
  %37 = call i32 @puts(ptr %35)
  %widen23 = sext i32 %37 to i64
  %38 = call i32 @avra_test_summary()
