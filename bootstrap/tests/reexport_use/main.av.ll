...
define ptr @"middle::inner::greet"(ptr %0) {
entry:
...
define i64 @"middle::inner::add"(i64 %0, i64 %1) {
entry:
...
entry:
  ...
  %1 = call ptr @"middle::inner::greet"(ptr @.str.1)
  %2 = call i32 @puts(ptr %1)
  %widen = sext i32 %2 to i64
  %3 = call i64 @"middle::inner::add"(i64 3, i64 4)
...
entry:
  %0 = call i64 @__init_middle()
  call void @avra_rc_collect()
  ret i64 0
}

define i64 @__init_middle() {
entry:
  %0 = call i64 @__init_inner()
  call void @avra_test_flush()
  ret i64 0
}

define i64 @__init_inner() {
entry:
  call void @avra_test_flush()
  ret i64 0
}
