...
@src_file = private unnamed_addr constant [99 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/dyn_dispatch.av\00", align 1
...
@src_file.4 = private unnamed_addr constant [99 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/dyn_dispatch.av\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 6, ptr @sty_name, i64 6, i64 %null_ext, ptr @src_file, i64 98, i64 13)
...
entry:
  ...
  %null_chk = icmp eq i64 %cast, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name.2, i64 4, ptr @sty_name.3, i64 6, i64 %null_ext, ptr @src_file.4, i64 98, i64 19)
...
define i64 @print_thing(i64 %0) {
entry:
  %d = alloca ptr, align 8
  %cast = inttoptr i64 %0 to ptr
  store ptr %cast, ptr %d, align 8
  %d1 = load ptr, ptr %d, align 8
  %1 = call i64 @avra_trait_object_value(ptr %d1)
  %2 = call ptr @avra_trait_object_vtable(ptr %d1)
...
entry:
  ...
  call void @avra_array_push(ptr %3, i64 ptrtoint (ptr @Circle__describe to i64))
  ...
  %fld_ptr5 = getelementptr inbounds nuw %Square, ptr %5, i32 0, i32 0
  ...
  call void @avra_array_push(ptr %7, i64 ptrtoint (ptr @Square__describe to i64))
  ...
  store ptr %cast10, ptr %s, align 8
  %c11 = load ptr, ptr %c, align 8
  %9 = call i64 @avra_trait_object_value(ptr %c11)
  %10 = call ptr @avra_trait_object_vtable(ptr %c11)
  %11 = call i64 @avra_array_get(ptr %10, i64 0)
  %12 = call i64 @avra_closure_call_1(i64 %11, i64 %9)
  %cast12 = inttoptr i64 %12 to ptr
  %13 = call i32 @puts(ptr %cast12)
  %widen = sext i32 %13 to i64
  %s13 = load ptr, ptr %s, align 8
  %14 = call i64 @avra_trait_object_value(ptr %s13)
  %15 = call ptr @avra_trait_object_vtable(ptr %s13)
  %16 = call i64 @avra_array_get(ptr %15, i64 0)
  %17 = call i64 @avra_closure_call_1(i64 %16, i64 %14)
  %cast14 = inttoptr i64 %17 to ptr
  %18 = call i32 @puts(ptr %cast14)
  %widen15 = sext i32 %18 to i64
  %c16 = load ptr, ptr %c, align 8
  %cast17 = ptrtoint ptr %c16 to i64
  %19 = call i64 @print_thing(i64 %cast17)
  %s18 = load ptr, ptr %s, align 8
  %cast19 = ptrtoint ptr %s18 to i64
  %20 = call i64 @print_thing(i64 %cast19)
  ret i64 %20
}
