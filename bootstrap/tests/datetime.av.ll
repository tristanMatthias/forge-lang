...
@.str.8 = private unnamed_addr constant [8 x i8] c"year ok\00", align 1
@.str.9 = private unnamed_addr constant [9 x i8] c"month ok\00", align 1
@.str.10 = private unnamed_addr constant [7 x i8] c"day ok\00", align 1
@.str.11 = private unnamed_addr constant [8 x i8] c"hour ok\00", align 1
@.str.12 = private unnamed_addr constant [10 x i8] c"minute ok\00", align 1
@.str.13 = private unnamed_addr constant [10 x i8] c"second ok\00", align 1
...
declare i64 @avra_datetime_year.2(i64)

declare i64 @avra_datetime_month.3(i64)

declare i64 @avra_datetime_day.4(i64)

declare i64 @avra_datetime_hour.5(i64)

declare i64 @avra_datetime_minute.6(i64)

declare i64 @avra_datetime_second.7(i64)
...
ifcont:                                           ; preds = %if_else, %if_then
  ...
  store i64 %2, ptr %year, align 8
  %year3 = load i64, ptr %year, align 8
  %sge = icmp sge i64 %year3, 2026
...
ifcont4:                                          ; preds = %if_else7, %if_then6
  ...
  store i64 %4, ptr %month, align 8
  %month11 = load i64, ptr %month, align 8
  %sge12 = icmp sge i64 %month11, 1
...
sc_rhs:                                           ; preds = %ifcont4
  %month14 = load i64, ptr %month, align 8
  %sle = icmp sle i64 %month14, 12
...
ifcont15:                                         ; preds = %if_else18, %if_then17
  ...
  store i64 %6, ptr %day, align 8
  %day22 = load i64, ptr %day, align 8
  %sge23 = icmp sge i64 %day22, 1
...
sc_rhs26:                                         ; preds = %ifcont15
  %day29 = load i64, ptr %day, align 8
  %sle30 = icmp sle i64 %day29, 31
...
ifcont38:                                         ; preds = %if_else41, %if_then40
  ...
  store i64 %8, ptr %hour, align 8
  %hour45 = load i64, ptr %hour, align 8
  %sge46 = icmp sge i64 %hour45, 0
...
sc_rhs49:                                         ; preds = %ifcont38
  %hour52 = load i64, ptr %hour, align 8
  %sle53 = icmp sle i64 %hour52, 23
...
ifcont61:                                         ; preds = %if_else64, %if_then63
  ...
  store i64 %10, ptr %minute, align 8
  %minute68 = load i64, ptr %minute, align 8
  %sge69 = icmp sge i64 %minute68, 0
...
sc_rhs72:                                         ; preds = %ifcont61
  %minute75 = load i64, ptr %minute, align 8
  %sle76 = icmp sle i64 %minute75, 59
...
ifcont84:                                         ; preds = %if_else87, %if_then86
  ...
  %second91 = load i64, ptr %second, align 8
  %sge92 = icmp sge i64 %second91, 0
...
sc_rhs95:                                         ; preds = %ifcont84
  %second98 = load i64, ptr %second, align 8
  %sle99 = icmp sle i64 %second98, 59
...
sc_merge97:                                       ; preds = %sc_r_merge104, %sc_short96
  ...
  %sif_cond = icmp ne i64 %sc_ext106, 0
...
sif_then:                                         ; preds = %sc_merge97
  %14 = call i32 @puts(ptr @.str.13)
  %widen107 = sext i32 %14 to i64
  store i64 0, ptr %sif_result, align 8
  br label %sif_end

sif_else:                                         ; preds = %sc_merge97
  br label %sif_end
