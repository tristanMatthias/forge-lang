...
@.str.8 = private unnamed_addr constant [9 x i8] c"replaced\00", align 1
...
declare ptr @avra_file_read.1(ptr)

declare i64 @avra_file_write.2(ptr, ptr)

declare i64 @avra_file_exists.3(ptr)
...
entry:
  ...
  store ptr @.str, ptr %path, align 8
  %path1 = load ptr, ptr %path, align 8
  %1 = call i64 @avra_file_write(ptr %path1, ptr @.str.4)
  store i64 %1, ptr %ok, align 8
  %ok2 = load i64, ptr %ok, align 8
  %2 = call ptr @avra_rc_alloc(i64 32)
  %3 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %2, i64 32, ptr @.i2s_fmt, i64 %ok2)
  %widen = sext i32 %3 to i64
  %4 = call i32 @puts(ptr %2)
  %widen3 = sext i32 %4 to i64
  %path4 = load ptr, ptr %path, align 8
  %5 = call i64 @avra_file_exists(ptr %path4)
  ...
  %9 = call i64 @avra_file_exists(ptr @.str.6)
  ...
  %13 = call ptr @avra_file_read(ptr %path9)
  store ptr %13, ptr %content, align 8
  %content10 = load ptr, ptr %content, align 8
  %14 = call i32 @puts(ptr %content10)
  %widen11 = sext i32 %14 to i64
  %path12 = load ptr, ptr %path, align 8
  %15 = call i64 @avra_file_write(ptr %path12, ptr @.str.8)
  %path13 = load ptr, ptr %path, align 8
  %16 = call ptr @avra_file_read(ptr %path13)
