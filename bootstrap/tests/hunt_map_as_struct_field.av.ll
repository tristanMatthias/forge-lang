...
entry:
  ...
  store i64 %cast, ptr @cfg, align 8
  %1 = call ptr @avra_map_new_cstr()
  store ptr %1, ptr @m, align 8
  %m = load ptr, ptr @m, align 8
  call void @avra_map_set_cstr(ptr %m, ptr @.str, i64 ptrtoint (ptr @.str.1 to i64))
  %m1 = load ptr, ptr @m, align 8
  call void @avra_map_set_cstr(ptr %m1, ptr @.str.2, i64 ptrtoint (ptr @.str.3 to i64))
  %m2 = load ptr, ptr @m, align 8
  %2 = call i64 @avra_map_get_cstr(ptr %m2, ptr @.str.4)
  %cast3 = inttoptr i64 %2 to ptr
  %3 = call i32 @puts(ptr %cast3)
  %widen = sext i32 %3 to i64
  %m4 = load ptr, ptr @m, align 8
  %4 = call i64 @avra_map_len_cstr(ptr %m4)
  ...
  %8 = call ptr @avra_map_keys_cstr(ptr %m7)
  store ptr %8, ptr @keys, align 8
  %keys = load ptr, ptr @keys, align 8
  %9 = call i64 @avra_array_len(ptr %keys)
  %10 = call ptr @avra_rc_alloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.5, i64 %9)
