...
@.str.3 = private unnamed_addr constant [12 x i8] c"got value: \00", align 1
@.i2s_fmt = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"bad\00", align 1
@.str.5 = private unnamed_addr constant [11 x i8] c"fallback: \00", align 1
...
ifcont:                                           ; preds = %if_else
  ...
  %ret_tag_ptr = getelementptr inbounds nuw %Result, ptr %cast9, i32 0, i32 0
...
entry:
  ...
  %catch_result10 = alloca i64, align 8
  %v = alloca i64, align 8
  %catch_result = alloca i64, align 8
  %1 = call ptr @parse(ptr @.str.2)
  %catch_tag_ptr = getelementptr inbounds nuw %Result, ptr %1, i32 0, i32 0
...
catch_ok:                                         ; preds = %entry
  %catch_pay_slot = getelementptr inbounds nuw %Result, ptr %1, i32 0, i32 1
...
catch_merge:                                      ; preds = %catch_err, %catch_ok
  ...
  %10 = call ptr @parse(ptr @.str.4)
  %catch_tag_ptr4 = getelementptr inbounds nuw %Result, ptr %10, i32 0, i32 0
  %catch_tag5 = load i64, ptr %catch_tag_ptr4, align 8
  %catch_is_ok6 = icmp eq i64 %catch_tag5, 5862623
  br i1 %catch_is_ok6, label %catch_ok7, label %catch_err8

catch_ok7:                                        ; preds = %catch_merge
  %catch_pay_slot11 = getelementptr inbounds nuw %Result, ptr %10, i32 0, i32 1
  %catch_payload12 = load ptr, ptr %catch_pay_slot11, align 8
  %catch_ok_val13 = load i64, ptr %catch_payload12, align 8
  store i64 %catch_ok_val13, ptr %catch_result10, align 8
  br label %catch_merge9

catch_err8:                                       ; preds = %catch_merge
  %catch_err_pay_slot = getelementptr inbounds nuw %Result, ptr %10, i32 0, i32 1
  %catch_err_payload = load ptr, ptr %catch_err_pay_slot, align 8
  %catch_err_val = load i64, ptr %catch_err_payload, align 8
  %cast14 = inttoptr i64 %catch_err_val to ptr
  store ptr %cast14, ptr %e, align 8
  %e15 = load ptr, ptr %e, align 8
  %11 = call i32 @puts(ptr %e15)
  %widen16 = sext i32 %11 to i64
  store i64 0, ptr %catch_result10, align 8
  br label %catch_merge9

catch_merge9:                                     ; preds = %catch_err8, %catch_ok7
  %catch_merged17 = load i64, ptr %catch_result10, align 8
  store i64 %catch_merged17, ptr %v2, align 8
  %v218 = load i64, ptr %v2, align 8
  %12 = call ptr @avra_rc_alloc(i64 32)
  %13 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %12, i64 32, ptr @.i2s_fmt.6, i64 %v218)
  %widen19 = sext i32 %13 to i64
  %14 = call i64 @strlen(ptr @.str.5)
  %15 = call i64 @strlen(ptr %12)
  %concat_total20 = add i64 %14, %15
  %concat_size21 = add i64 %concat_total20, 1
  %16 = call ptr @avra_rc_alloc(i64 %concat_size21)
  %17 = call ptr @memcpy(ptr %16, ptr @.str.5, i64 %14)
  %cast22 = ptrtoint ptr %16 to i64
  %dst2_int23 = add i64 %cast22, %14
  %cast24 = inttoptr i64 %dst2_int23 to ptr
  %rhs_len_p125 = add i64 %15, 1
  %18 = call ptr @memcpy(ptr %cast24, ptr %12, i64 %rhs_len_p125)
