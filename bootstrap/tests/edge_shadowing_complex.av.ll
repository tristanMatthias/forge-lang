...
entry:
  ...
  store i64 2, ptr %x2, align 8
  %x3 = load i64, ptr %x2, align 8
  %3 = call ptr @avra_rc_alloc(i64 32)
  %4 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %3, i64 32, ptr @.i2s_fmt.1, i64 %x3)
  %widen4 = sext i32 %4 to i64
  %5 = call i32 @puts(ptr %3)
  %widen5 = sext i32 %5 to i64
  store i64 3, ptr %x6, align 8
  %x7 = load i64, ptr %x6, align 8
  %6 = call ptr @avra_rc_alloc(i64 32)
  %7 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %6, i64 32, ptr @.i2s_fmt.2, i64 %x7)
  %widen8 = sext i32 %7 to i64
  %8 = call i32 @puts(ptr %6)
  %widen9 = sext i32 %8 to i64
  store i64 4, ptr %x10, align 8
  %x11 = load i64, ptr %x10, align 8
  %add = add i64 %x11, 10
  store i64 %add, ptr %x10, align 8
  %x12 = load i64, ptr %x10, align 8
  %9 = call ptr @avra_rc_alloc(i64 32)
  %10 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %9, i64 32, ptr @.i2s_fmt.3, i64 %x12)
  %widen13 = sext i32 %10 to i64
  %11 = call i32 @puts(ptr %9)
  %widen14 = sext i32 %11 to i64
  %x15 = load i64, ptr %x6, align 8
  %12 = call ptr @avra_rc_alloc(i64 32)
  %13 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %12, i64 32, ptr @.i2s_fmt.4, i64 %x15)
  ...
  %16 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %15, i64 32, ptr @.i2s_fmt.5, i64 %x18)
  %widen19 = sext i32 %16 to i64
  %17 = call i32 @puts(ptr %15)
  %widen20 = sext i32 %17 to i64
  %x21 = load i64, ptr @x, align 8
  %18 = call ptr @avra_rc_alloc(i64 32)
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt.6, i64 %x21)
  %widen22 = sext i32 %19 to i64
  %20 = call i32 @puts(ptr %18)
  %widen23 = sext i32 %20 to i64
  store i64 100, ptr @val, align 8
...
forin.body:                                       ; preds = %forin.cond
  %23 = call i64 @avra_array_get(ptr %21, i64 %forin_i_val)
  store i64 %23, ptr %val, align 8
  %val24 = load i64, ptr %val, align 8
  %24 = call ptr @avra_rc_alloc(i64 32)
  %25 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %24, i64 32, ptr @.i2s_fmt.7, i64 %val24)
  %widen25 = sext i32 %25 to i64
...
forin.exit:                                       ; preds = %forin.cond
  %val27 = load i64, ptr @val, align 8
  %27 = call ptr @avra_rc_alloc(i64 32)
  %28 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %27, i64 32, ptr @.i2s_fmt.8, i64 %val27)
  %widen28 = sext i32 %28 to i64
  %29 = call i32 @puts(ptr %27)
  %widen29 = sext i32 %29 to i64
  %30 = call i32 @avra_test_summary()
  %widen30 = sext i32 %30 to i64
