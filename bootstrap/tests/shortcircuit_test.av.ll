...
@sc_x = global i64 0
@spec_str = private unnamed_addr constant [15 x i8] c"\22shortcircuit\22\00", align 1
@spec_str.1 = private unnamed_addr constant [22 x i8] c"\22false and skips rhs\22\00", align 1
@spec_str.2 = private unnamed_addr constant [20 x i8] c"\22true or skips rhs\22\00", align 1
@spec_str.3 = private unnamed_addr constant [25 x i8] c"\22true and evaluates rhs\22\00", align 1
...
define i64 @sc_side_effect() {
entry:
  %sc_x = load i64, ptr @sc_x, align 8
  %add = add i64 %sc_x, 1
  store i64 %add, ptr @sc_x, align 8
  ret i64 1
}

define i64 @sc_run_false_and() {
entry:
  store i64 0, ptr @sc_x, align 8
  br i1 false, label %sc_rhs, label %sc_short

sc_rhs:                                           ; preds = %entry
  %0 = call i64 @sc_side_effect()
  %eq = icmp eq i64 %0, 1
...
if_then:                                          ; preds = %sc_merge
  store i64 999, ptr @sc_x, align 8
  br label %ifcont
...
define i64 @sc_run_true_or() {
entry:
  store i64 0, ptr @sc_x, align 8
  br i1 true, label %sc_short, label %sc_rhs
...
ifcont:                                           ; preds = %if_else, %if_then
  %sc_x1 = load i64, ptr @sc_x, align 8
  ret i64 %sc_x1

if_then:                                          ; preds = %sc_merge
  %sc_x = load i64, ptr @sc_x, align 8
  store i64 %sc_x, ptr @sc_x, align 8
  br label %ifcont
