...
@.str = private unnamed_addr constant [15 x i8] c"using resource\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"cleanup done\00", align 1
@.str.2 = private unnamed_addr constant [13 x i8] c"copy works: \00", align 1
...
@src_file = private unnamed_addr constant [102 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/memory_red_team.av\00", align 1
...
entry:
  ...
  store ptr %p3, ptr %q, align 8
  %q4 = load ptr, ptr %q, align 8
  %cast5 = ptrtoint ptr %q4 to i64
  %null_chk = icmp eq i64 %cast5, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name, i64 1, ptr @sty_name, i64 5, i64 %null_ext, ptr @src_file, i64 101, i64 17)
  %x_ptr = getelementptr inbounds nuw %Point, ptr %q4, i32 0, i32 0
  %x = load i64, ptr %x_ptr, align 8
  %3 = call ptr @avra_rc_alloc(i64 32)
  %4 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %3, i64 32, ptr @.i2s_fmt, i64 %x)
  ...
  %9 = call ptr @memcpy(ptr %cast7, ptr %3, i64 %rhs_len_p1)
