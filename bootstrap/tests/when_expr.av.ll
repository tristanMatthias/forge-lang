...
when_end:                                         ; preds = %when_next9, %when_arm8, %when_arm4, %when_arm
...
when_next5:                                       ; preds = %when_next
  ...
  %sgt = icmp sgt i64 %n6, 100
  %sgt_ext = zext i1 %sgt to i64
  %when_cond7 = icmp ne i64 %sgt_ext, 0
  br i1 %when_cond7, label %when_arm8, label %when_next9

when_arm8:                                        ; preds = %when_next5
  store i64 ptrtoint (ptr @.str.2 to i64), ptr %when_result, align 8
  br label %when_end

when_next9:                                       ; preds = %when_next5
