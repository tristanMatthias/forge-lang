...
@.str = private unnamed_addr constant [5 x i8] c"val=\00", align 1
...
define ptr @make_formatter(ptr %0) {
entry:
...
define i64 @main() {
entry:
  %0 = call ptr @make_formatter(ptr @.str)
  store ptr %0, ptr @fmt, align 8
  %fmt = load i64, ptr @fmt, align 8
  %1 = call i64 @avra_closure_call_1(i64 %fmt, i64 42)
  %cast = inttoptr i64 %1 to ptr
  %2 = call i32 @puts(ptr %cast)
  %widen = sext i32 %2 to i64
  %fmt1 = load i64, ptr @fmt, align 8
  %3 = call i64 @avra_closure_call_1(i64 %fmt1, i64 99)
...
entry:
  ...
  %3 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %2, i64 32, ptr @.i2s_fmt, i64 %x2)
  %widen = sext i32 %3 to i64
  %4 = call i64 @strlen(ptr %prefix1)
  %5 = call i64 @strlen(ptr %2)
  %concat_total = add i64 %4, %5
  %concat_size = add i64 %concat_total, 1
  %6 = call ptr @avra_rc_alloc(i64 %concat_size)
  %7 = call ptr @memcpy(ptr %6, ptr %prefix1, i64 %4)
  %cast3 = ptrtoint ptr %6 to i64
  %dst2_int = add i64 %cast3, %4
  %cast4 = inttoptr i64 %dst2_int to ptr
  %rhs_len_p1 = add i64 %5, 1
  %8 = call ptr @memcpy(ptr %cast4, ptr %2, i64 %rhs_len_p1)
