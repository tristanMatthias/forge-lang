...
entry:
  ...
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt.6, i64 5)
  %widen12 = sext i32 %19 to i64
  %20 = call i32 @puts(ptr %18)
  %widen13 = sext i32 %20 to i64
  %21 = call ptr @avra_rc_alloc(i64 32)
  %22 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %21, i64 32, ptr @.i2s_fmt.7, i64 -15)
