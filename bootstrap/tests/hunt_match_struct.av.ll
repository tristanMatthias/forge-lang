...
@mu_file = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/hunt_match_struct.av\00", align 1
@.match_fn.5 = private unnamed_addr constant [5 x i8] c"area\00", align 1
@mu_file.6 = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/hunt_match_struct.av\00", align 1
...
march_next7:                                      ; preds = %march_next
  call void @avra_match_unreachable(ptr @.match_fn.5, i64 %tag, ptr @mu_file.6, i64 21)
  unreachable
}
...
entry:
  ...
  store i64 6384501107, ptr %tag_ptr2, align 8
  ...
  %slot_base7 = ptrtoint ptr %5 to i64
  ...
  %6 = call ptr @describe(ptr %cast11)
  %7 = call i32 @puts(ptr %6)
  %widen12 = sext i32 %7 to i64
  %8 = call ptr @avra_rc_alloc(i64 16)
  %tag_ptr13 = getelementptr inbounds nuw %Shape, ptr %8, i32 0, i32 0
  store i64 6952139942519, ptr %tag_ptr13, align 8
  %pay_ptr14 = getelementptr inbounds nuw %Shape, ptr %8, i32 0, i32 1
  ...
  store i64 5, ptr %slot17, align 8
  %cast18 = ptrtoint ptr %8 to i64
  %cast19 = inttoptr i64 %cast18 to ptr
  %10 = call i64 @area(ptr %cast19)
  %11 = call ptr @avra_rc_alloc(i64 32)
  %12 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %11, i64 32, ptr @.i2s_fmt.7, i64 %10)
  %widen20 = sext i32 %12 to i64
  %13 = call i32 @puts(ptr %11)
  %widen21 = sext i32 %13 to i64
  %14 = call ptr @avra_rc_alloc(i64 16)
  %tag_ptr22 = getelementptr inbounds nuw %Shape, ptr %14, i32 0, i32 0
  store i64 6384501107, ptr %tag_ptr22, align 8
  %pay_ptr23 = getelementptr inbounds nuw %Shape, ptr %14, i32 0, i32 1
  %15 = call ptr @avra_rc_alloc(i64 16)
  store ptr %15, ptr %pay_ptr23, align 8
  %slot_base24 = ptrtoint ptr %15 to i64
  %slot_addr25 = add i64 %slot_base24, 0
  %slot26 = inttoptr i64 %slot_addr25 to ptr
  store i64 3, ptr %slot26, align 8
  %slot_base27 = ptrtoint ptr %15 to i64
  %slot_addr28 = add i64 %slot_base27, 8
  %slot29 = inttoptr i64 %slot_addr28 to ptr
  store i64 4, ptr %slot29, align 8
  %cast30 = ptrtoint ptr %14 to i64
  %cast31 = inttoptr i64 %cast30 to ptr
  %16 = call i64 @area(ptr %cast31)
  %17 = call ptr @avra_rc_alloc(i64 32)
  %18 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %17, i64 32, ptr @.i2s_fmt.8, i64 %16)
  %widen32 = sext i32 %18 to i64
  %19 = call i32 @puts(ptr %17)
  %widen33 = sext i32 %19 to i64
