...
@.str.1 = private unnamed_addr constant [4 x i8] c"srv\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c" on port \00", align 1
...
entry:
  ...
  %concat_total2 = add i64 %6, %7
  %concat_size3 = add i64 %concat_total2, 1
  %8 = call ptr @avra_rc_alloc(i64 %concat_size3)
  %9 = call ptr @memcpy(ptr %8, ptr %3, i64 %6)
  %cast4 = ptrtoint ptr %8 to i64
  %dst2_int5 = add i64 %cast4, %6
  %cast6 = inttoptr i64 %dst2_int5 to ptr
  %rhs_len_p17 = add i64 %7, 1
  %10 = call ptr @memcpy(ptr %cast6, ptr @.str.2, i64 %rhs_len_p17)
  %11 = call ptr @avra_rc_alloc(i64 32)
  %12 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %11, i64 32, ptr @.i2s_fmt, i64 8080)
  %widen = sext i32 %12 to i64
  %13 = call i64 @strlen(ptr %8)
  %14 = call i64 @strlen(ptr %11)
  %concat_total8 = add i64 %13, %14
  %concat_size9 = add i64 %concat_total8, 1
  %15 = call ptr @avra_rc_alloc(i64 %concat_size9)
  %16 = call ptr @memcpy(ptr %15, ptr %8, i64 %13)
  %cast10 = ptrtoint ptr %15 to i64
  %dst2_int11 = add i64 %cast10, %13
  %cast12 = inttoptr i64 %dst2_int11 to ptr
  %rhs_len_p113 = add i64 %14, 1
  %17 = call ptr @memcpy(ptr %cast12, ptr %11, i64 %rhs_len_p113)
  %18 = call i32 @puts(ptr %15)
  %widen14 = sext i32 %18 to i64
  %19 = call i64 @strlen(ptr @.str.3)
  %20 = call i64 @strlen(ptr @.str.4)
  %concat_total15 = add i64 %19, %20
  %concat_size16 = add i64 %concat_total15, 1
  %21 = call ptr @avra_rc_alloc(i64 %concat_size16)
  %22 = call ptr @memcpy(ptr %21, ptr @.str.3, i64 %19)
  %cast17 = ptrtoint ptr %21 to i64
  %dst2_int18 = add i64 %cast17, %19
  %cast19 = inttoptr i64 %dst2_int18 to ptr
  %rhs_len_p120 = add i64 %20, 1
  %23 = call ptr @memcpy(ptr %cast19, ptr @.str.4, i64 %rhs_len_p120)
  %24 = call i64 @strlen(ptr %21)
  %25 = call i64 @strlen(ptr @.str.5)
  %concat_total21 = add i64 %24, %25
  %concat_size22 = add i64 %concat_total21, 1
  %26 = call ptr @avra_rc_alloc(i64 %concat_size22)
  %27 = call ptr @memcpy(ptr %26, ptr %21, i64 %24)
  %cast23 = ptrtoint ptr %26 to i64
  %dst2_int24 = add i64 %cast23, %24
  %cast25 = inttoptr i64 %dst2_int24 to ptr
  %rhs_len_p126 = add i64 %25, 1
  %28 = call ptr @memcpy(ptr %cast25, ptr @.str.5, i64 %rhs_len_p126)
