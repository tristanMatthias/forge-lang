...
@.str.8 = private unnamed_addr constant [6 x i8] c"2.0.0\00", align 1
@.i2s_fmt.9 = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.str.10 = private unnamed_addr constant [6 x i8] c"2.0.0\00", align 1
...
@.str.13 = private unnamed_addr constant [6 x i8] c"1.2.3\00", align 1
@.str.14 = private unnamed_addr constant [6 x i8] c"1.2.3\00", align 1
@.i2s_fmt.15 = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.str.16 = private unnamed_addr constant [6 x i8] c"1.2.3\00", align 1
@.str.17 = private unnamed_addr constant [6 x i8] c"1.2.4\00", align 1
...
declare i64 @avra_semver_major.1(ptr)

declare i64 @avra_semver_minor.2(ptr)

declare i64 @avra_semver_patch.3(ptr)

declare i64 @avra_semver_compare.4(ptr, ptr)

define i64 @main() {
entry:
  %0 = call i64 @__bs_top_level()
  %v = alloca ptr, align 8
  store ptr @.str, ptr %v, align 8
  %v1 = load ptr, ptr %v, align 8
  %1 = call i64 @avra_semver_major(ptr %v1)
  ...
  %5 = call i64 @avra_semver_minor(ptr %v3)
  %6 = call ptr @avra_rc_alloc(i64 32)
  %7 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %6, i64 32, ptr @.i2s_fmt.5, i64 %5)
  %widen4 = sext i32 %7 to i64
  %8 = call i32 @puts(ptr %6)
  %widen5 = sext i32 %8 to i64
  %v6 = load ptr, ptr %v, align 8
  %9 = call i64 @avra_semver_patch(ptr %v6)
  %10 = call ptr @avra_rc_alloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.6, i64 %9)
  %widen7 = sext i32 %11 to i64
  %12 = call i32 @puts(ptr %10)
  %widen8 = sext i32 %12 to i64
  %13 = call i64 @avra_semver_compare(ptr @.str.7, i64 ptrtoint (ptr @.str.8 to i64))
  %14 = call ptr @avra_rc_alloc(i64 32)
  %15 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %14, i64 32, ptr @.i2s_fmt.9, i64 %13)
  %widen9 = sext i32 %15 to i64
  %16 = call i32 @puts(ptr %14)
  %widen10 = sext i32 %16 to i64
  %17 = call i64 @avra_semver_compare(ptr @.str.10, i64 ptrtoint (ptr @.str.11 to i64))
  %18 = call ptr @avra_rc_alloc(i64 32)
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt.12, i64 %17)
  %widen11 = sext i32 %19 to i64
  %20 = call i32 @puts(ptr %18)
  %widen12 = sext i32 %20 to i64
  %21 = call i64 @avra_semver_compare(ptr @.str.13, i64 ptrtoint (ptr @.str.14 to i64))
  ...
  %25 = call i64 @avra_semver_compare(ptr @.str.16, i64 ptrtoint (ptr @.str.17 to i64))
  %26 = call ptr @avra_rc_alloc(i64 32)
  %27 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %26, i64 32, ptr @.i2s_fmt.18, i64 %25)
  %widen15 = sext i32 %27 to i64
  %28 = call i32 @puts(ptr %26)
  %widen16 = sext i32 %28 to i64
  ret i64 0
}
