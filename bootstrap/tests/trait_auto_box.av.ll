...
@src_file = private unnamed_addr constant [101 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/trait_auto_box.av\00", align 1
...
@src_file.4 = private unnamed_addr constant [101 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/trait_auto_box.av\00", align 1
...
@.str.7 = private unnamed_addr constant [6 x i8] c"Buddy\00", align 1
@.str.8 = private unnamed_addr constant [5 x i8] c"Luna\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 4, ptr @sty_name, i64 3, i64 %null_ext, ptr @src_file, i64 100, i64 13)
...
entry:
  ...
  %null_chk = icmp eq i64 %cast, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name.2, i64 4, ptr @sty_name.3, i64 3, i64 %null_ext, ptr @src_file.4, i64 100, i64 19)
...
entry:
  ...
  call void @avra_array_push(ptr %3, i64 ptrtoint (ptr @Dog__greet to i64))
  ...
  %5 = call i64 @say_hi(i64 %4)
  %6 = call ptr @avra_rc_alloc(i64 8)
  %fld_ptr4 = getelementptr inbounds nuw %Cat, ptr %6, i32 0, i32 0
  store ptr @.str.6, ptr %fld_ptr4, align 8
  ...
  call void @avra_array_push(ptr %8, i64 ptrtoint (ptr @Cat__greet to i64))
  %cast6 = ptrtoint ptr %8 to i64
  call void @avra_array_push(ptr %7, i64 %cast6)
  %cast7 = inttoptr i64 %cast5 to ptr
  %cast8 = ptrtoint ptr %7 to i64
  %9 = call i64 @avra_trait_object_new(ptr %cast7, i64 %cast8)
  %10 = call i64 @say_hi(i64 %9)
  %11 = call ptr @avra_rc_alloc(i64 8)
  %fld_ptr9 = getelementptr inbounds nuw %Dog, ptr %11, i32 0, i32 0
  store ptr @.str.7, ptr %fld_ptr9, align 8
  %cast10 = ptrtoint ptr %11 to i64
  %cast11 = inttoptr i64 %cast10 to ptr
  store ptr %cast11, ptr %d, align 8
  %12 = call ptr @avra_rc_alloc(i64 8)
  %fld_ptr12 = getelementptr inbounds nuw %Cat, ptr %12, i32 0, i32 0
  store ptr @.str.8, ptr %fld_ptr12, align 8
  ...
  call void @avra_array_push(ptr %14, i64 ptrtoint (ptr @Dog__greet to i64))
  %cast16 = ptrtoint ptr %14 to i64
  call void @avra_array_push(ptr %13, i64 %cast16)
  %cast17 = ptrtoint ptr %13 to i64
  %15 = call i64 @avra_trait_object_new(ptr %d15, i64 %cast17)
  %16 = call i64 @say_hi(i64 %15)
  ...
  call void @avra_array_push(ptr %18, i64 ptrtoint (ptr @Cat__greet to i64))
  %cast19 = ptrtoint ptr %18 to i64
  call void @avra_array_push(ptr %17, i64 %cast19)
  %cast20 = ptrtoint ptr %17 to i64
  %19 = call i64 @avra_trait_object_new(ptr %c18, i64 %cast20)
  %20 = call i64 @say_hi(i64 %19)
  ret i64 %20
}
