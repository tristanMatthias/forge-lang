...
%CbResult = type { i64, ptr }
%CbResult__CbErr = type { ptr }
...
@.match_fn = private unnamed_addr constant [13 x i8] c"cb_unwrap_or\00", align 1
@mu_file = private unnamed_addr constant [26 x i8] c"tests/catch_basic_test.fg\00", align 1
@spec_str = private unnamed_addr constant [14 x i8] c"\22catch basic\22\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"bad\00", align 1
@spec_str.3 = private unnamed_addr constant [24 x i8] c"\22error returns default\22\00", align 1
@.str.4 = private unnamed_addr constant [3 x i8] c"42\00", align 1
@spec_str.5 = private unnamed_addr constant [24 x i8] c"\22success returns value\22\00", align 1
...
ifcont:                                           ; preds = %if_else
  ...
  %tag_ptr3 = getelementptr inbounds nuw %CbResult, ptr %2, i32 0, i32 0
  store i64 210670607283, ptr %tag_ptr3, align 8
  %pay_ptr4 = getelementptr inbounds nuw %CbResult, ptr %2, i32 0, i32 1
...
if_then:                                          ; preds = %entry
  ...
  %tag_ptr = getelementptr inbounds nuw %CbResult, ptr %4, i32 0, i32 0
  store i64 6383958116, ptr %tag_ptr, align 8
  %pay_ptr = getelementptr inbounds nuw %CbResult, ptr %4, i32 0, i32 1
...
define i64 @cb_unwrap_or(ptr %0, i64 %1) {
entry:
  ...
  %tag_ptr = getelementptr inbounds nuw %CbResult, ptr %r1, i32 0, i32 0
  %tag = load i64, ptr %tag_ptr, align 8
  store i64 0, ptr %match_result, align 8
  %tag_eq = icmp eq i64 %tag, 6383958116
...
march_arm:                                        ; preds = %entry
  %pay_slot = getelementptr inbounds nuw %CbResult, ptr %r1, i32 0, i32 1
...
march_next:                                       ; preds = %entry
  %tag_eq6 = icmp eq i64 %tag, 210670607283
...
entry:
  ...
  %1 = call ptr @cb_parse_int(ptr @.str.2)
  %2 = call i64 @cb_unwrap_or(ptr %1, i64 8080)
  %eq = icmp eq i64 %2, 8080
  %eq_ext = zext i1 %eq to i64
  %3 = call i64 @forge_test_run_then(ptr @spec_str.3, i64 %eq_ext)
  %4 = call ptr @cb_parse_int(ptr @.str.4)
  %5 = call i64 @cb_unwrap_or(ptr %4, i64 9999)
  %eq1 = icmp eq i64 %5, 42
  %eq_ext2 = zext i1 %eq1 to i64
  %6 = call i64 @forge_test_run_then(ptr @spec_str.5, i64 %eq_ext2)
...
define i64 @__release_CbResult(ptr %0) {
entry:
...
do_free:                                          ; preds = %entry
  %tag_ptr = getelementptr inbounds nuw %CbResult, ptr %0, i32 0, i32 0
  %tag = load i64, ptr %tag_ptr, align 8
  %pay_ptr = getelementptr inbounds nuw %CbResult, ptr %0, i32 0, i32 1
  %payload = load ptr, ptr %pay_ptr, align 8
  %is_CbErr = icmp eq i64 %tag, 210670607283
  br i1 %is_CbErr, label %rel_CbErr, label %try_next_CbErr
...
fields_done:                                      ; preds = %try_next_CbErr, %vrel_error_skip
  call void @forge_rc_free(ptr %0)
  br label %done

rel_CbErr:                                        ; preds = %do_free
  %vrel_error_ptr = getelementptr inbounds nuw %CbResult__CbErr, ptr %payload, i32 0, i32 0
...
try_next_CbErr:                                   ; preds = %do_free
  br label %fields_done

vrel_error_skip:                                  ; preds = %vrel_error_do, %rel_CbErr
  br label %fields_done

vrel_error_do:                                    ; preds = %rel_CbErr
