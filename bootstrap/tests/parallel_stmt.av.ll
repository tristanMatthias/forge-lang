...
@.str = private unnamed_addr constant [13 x i8] c"3 tasks done\00", align 1
...
entry:
  ...
  call void @avra_array_push(ptr %2, i64 ptrtoint (ptr @task_a to i64))
  ...
  call void @avra_array_push(ptr %3, i64 ptrtoint (ptr @task_b to i64))
  ...
  call void @avra_array_push(ptr %4, i64 ptrtoint (ptr @task_c to i64))
  %cast2 = ptrtoint ptr %4 to i64
  call void @avra_array_push(ptr %1, i64 %cast2)
  %5 = call i32 @avra_parallel_run(ptr %1)
