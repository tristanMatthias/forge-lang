...
entry:
  ...
  %add100 = alloca ptr, align 8
  %add5 = alloca ptr, align 8
  %1 = call ptr @make_adder(i64 5)
  store ptr %1, ptr %add5, align 8
  %add51 = load i64, ptr %add5, align 8
  %2 = call i64 @avra_closure_call_1(i64 %add51, i64 10)
  ...
  %6 = call ptr @make_adder(i64 100)
  store ptr %6, ptr %add100, align 8
  %add1003 = load i64, ptr %add100, align 8
  %7 = call i64 @avra_closure_call_1(i64 %add1003, i64 42)
