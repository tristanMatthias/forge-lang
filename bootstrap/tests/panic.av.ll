...
@.str.2 = private unnamed_addr constant [9 x i8] c"no panic\00", align 1
...
nc_end:                                           ; preds = %nc_rhs, %entry
  ...
  store i64 %nc_val, ptr @user, align 8
  %user = load ptr, ptr @user, align 8
  %6 = call i32 @puts(ptr %user)
