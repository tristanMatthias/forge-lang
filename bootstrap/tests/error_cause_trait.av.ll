...
@src_file = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/error_cause_trait.av\00", align 1
@.str = private unnamed_addr constant [3 x i8] c"io\00", align 1
@fld_name.1 = private unnamed_addr constant [4 x i8] c"msg\00", align 1
@sty_name.2 = private unnamed_addr constant [9 x i8] c"AppError\00", align 1
@src_file.3 = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/error_cause_trait.av\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"app\00", align 1
@fld_name.5 = private unnamed_addr constant [6 x i8] c"inner\00", align 1
@sty_name.6 = private unnamed_addr constant [9 x i8] c"AppError\00", align 1
@src_file.7 = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/error_cause_trait.av\00", align 1
@.str.8 = private unnamed_addr constant [3 x i8] c": \00", align 1
@.str.9 = private unnamed_addr constant [14 x i8] c"  caused by: \00", align 1
@.str.10 = private unnamed_addr constant [19 x i8] c"connection refused\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 3, ptr @sty_name, i64 7, i64 %null_ext, ptr @src_file, i64 103, i64 14)
...
define ptr @IoError__cause(ptr %0) {
entry:
  %self = alloca ptr, align 8
  store ptr %0, ptr %self, align 8
  %self1 = load ptr, ptr %self, align 8
  ...
  call void @avra_array_push(ptr %2, i64 ptrtoint (ptr @IoError__message to i64))
  ...
  call void @avra_array_push(ptr %3, i64 ptrtoint (ptr @IoError__kind to i64))
  %cast2 = ptrtoint ptr %3 to i64
  call void @avra_array_push(ptr %1, i64 %cast2)
  %4 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %4, i64 -559038737)
  call void @avra_array_push(ptr %4, i64 ptrtoint (ptr @IoError__cause to i64))
  %cast3 = ptrtoint ptr %4 to i64
  call void @avra_array_push(ptr %1, i64 %cast3)
  %cast4 = ptrtoint ptr %1 to i64
  %5 = call i64 @avra_trait_object_new(ptr %self1, i64 %cast4)
  %cast5 = inttoptr i64 %5 to ptr
  ret ptr %cast5
}
...
entry:
  ...
  %null_chk = icmp eq i64 %cast, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name.1, i64 3, ptr @sty_name.2, i64 8, i64 %null_ext, ptr @src_file.3, i64 103, i64 20)
...
define ptr @AppError__cause(ptr %0) {
entry:
  %self = alloca ptr, align 8
  store ptr %0, ptr %self, align 8
  %self1 = load ptr, ptr %self, align 8
  ...
  %null_chk = icmp eq i64 %cast, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name.5, i64 5, ptr @sty_name.6, i64 8, i64 %null_ext, ptr @src_file.7, i64 103, i64 22)
  ...
  call void @avra_array_push(ptr %1, i64 %cast4)
  %cast5 = ptrtoint ptr %1 to i64
  %5 = call i64 @avra_trait_object_new(ptr %inner, i64 %cast5)
...
entry:
  ...
  %9 = call ptr @memcpy(ptr %cast4, ptr @.str.8, i64 %rhs_len_p1)
  ...
  %24 = call i64 @avra_trait_object_value(ptr %c15)
  %25 = call ptr @avra_trait_object_vtable(ptr %c15)
  %26 = call i64 @avra_array_get(ptr %25, i64 0)
  %27 = call i64 @avra_closure_call_1(i64 %26, i64 %24)
  %cast16 = inttoptr i64 %27 to ptr
  %28 = call i64 @strlen(ptr @.str.9)
  %29 = call i64 @strlen(ptr %cast16)
  %concat_total17 = add i64 %28, %29
  %concat_size18 = add i64 %concat_total17, 1
  %30 = call ptr @avra_rc_alloc(i64 %concat_size18)
  %31 = call ptr @memcpy(ptr %30, ptr @.str.9, i64 %28)
  %cast19 = ptrtoint ptr %30 to i64
  %dst2_int20 = add i64 %cast19, %28
  %cast21 = inttoptr i64 %dst2_int20 to ptr
  %rhs_len_p122 = add i64 %29, 1
  %32 = call ptr @memcpy(ptr %cast21, ptr %cast16, i64 %rhs_len_p122)
...
entry:
  ...
  store ptr @.str.11, ptr %fld_ptr2, align 8
  ...
  call void @avra_array_push(ptr %6, i64 ptrtoint (ptr @AppError__cause to i64))
