...
define i64 @"mathlib::add"(i64 %0, i64 %1) {
entry:
...
define i64 @"mathlib::mul"(i64 %0, i64 %1) {
entry:
  %b = alloca i64, align 8
  %a = alloca i64, align 8
  store i64 %0, ptr %a, align 8
...
define i64 @"mathlib::internal_helper"() {
entry:
  ret i64 99
}
...
entry:
  ...
  %1 = call i64 @"mathlib::add"(i64 3, i64 4)
  ...
  %5 = call i64 @"mathlib::mul"(i64 5, i64 6)
...
entry:
  %0 = call i64 @__init_mathlib()
  call void @avra_rc_collect()
  ret i64 0
}

define i64 @__init_mathlib() {
entry:
