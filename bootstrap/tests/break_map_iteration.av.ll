...
entry:
  ...
  %1 = call ptr @avra_map_keys_cstr(ptr %m)
  store ptr %1, ptr @keys, align 8
  %keys = load ptr, ptr @keys, align 8
  %2 = call i64 @avra_array_len(ptr %keys)
...
forin.body:                                       ; preds = %forin.cond
  %3 = call i64 @avra_array_get(ptr %keys, i64 %forin_i_val)
  store i64 %3, ptr %k, align 8
  %k1 = load ptr, ptr %k, align 8
  %4 = call i32 @puts(ptr %k1)
  %widen = sext i32 %4 to i64
  %m2 = load ptr, ptr @m, align 8
  %k3 = load ptr, ptr %k, align 8
  %5 = call i64 @avra_map_get_cstr(ptr %m2, ptr %k3)
