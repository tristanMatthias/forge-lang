...
%HasName = type { ptr }
%User = type { ptr, ptr, i64 }
%Product = type { ptr, i64 }
%HasEmail = type { ptr }
...
@src_file = private unnamed_addr constant [98 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/shape_basic.av\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"alice\00", align 1
@.str.2 = private unnamed_addr constant [11 x i8] c"a@test.com\00", align 1
...
entry:
  ...
  store ptr %0, ptr %thing, align 8
  %thing1 = load ptr, ptr %thing, align 8
  %cast = ptrtoint ptr %thing1 to i64
  %null_chk = icmp eq i64 %cast, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name, i64 4, ptr @sty_name, i64 7, i64 %null_ext, ptr @src_file, i64 97, i64 10)
  %name_ptr = getelementptr inbounds nuw %HasName, ptr %thing1, i32 0, i32 0
...
entry:
  ...
  store ptr @.str.2, ptr %fld_ptr1, align 8
  %fld_ptr2 = getelementptr inbounds nuw %User, ptr %1, i32 0, i32 2
  store i64 30, ptr %fld_ptr2, align 8
  %cast = ptrtoint ptr %1 to i64
  %cast3 = inttoptr i64 %cast to ptr
  store ptr %cast3, ptr %user, align 8
  %user4 = load ptr, ptr %user, align 8
  %2 = call ptr @greet(ptr %user4)
  %3 = call i32 @puts(ptr %2)
  %widen = sext i32 %3 to i64
  %4 = call ptr @avra_rc_alloc(i64 16)
  %fld_ptr5 = getelementptr inbounds nuw %Product, ptr %4, i32 0, i32 0
  store ptr @.str.3, ptr %fld_ptr5, align 8
  %fld_ptr6 = getelementptr inbounds nuw %Product, ptr %4, i32 0, i32 1
  store i64 10, ptr %fld_ptr6, align 8
  %cast7 = ptrtoint ptr %4 to i64
  %cast8 = inttoptr i64 %cast7 to ptr
  store ptr %cast8, ptr %product, align 8
  %product9 = load ptr, ptr %product, align 8
  %5 = call ptr @greet(ptr %product9)
  %6 = call i32 @puts(ptr %5)
  %widen10 = sext i32 %6 to i64
  %7 = call ptr @avra_rc_alloc(i64 8)
  %fld_ptr11 = getelementptr inbounds nuw %HasName, ptr %7, i32 0, i32 0
  store ptr @.str.4, ptr %fld_ptr11, align 8
  %cast12 = ptrtoint ptr %7 to i64
  %cast13 = inttoptr i64 %cast12 to ptr
  store ptr %cast13, ptr %named, align 8
  %named14 = load ptr, ptr %named, align 8
  %8 = call ptr @greet(ptr %named14)
...
define i64 @__release_Product(ptr %0) {
entry:
...
do_free:                                          ; preds = %entry
  %rel_name_ptr = getelementptr inbounds nuw %Product, ptr %0, i32 0, i32 0
...
rel_name_skip:                                    ; preds = %rel_name_do, %do_free
  %rel_email_ptr = getelementptr inbounds nuw %User, ptr %0, i32 0, i32 1
...
define i64 @__release_HasEmail(ptr %0) {
entry:
  %1 = call i64 @avra_rc_should_free(ptr %0)
  %should_free = icmp ne i64 %1, 0
  br i1 %should_free, label %do_free, label %alive
...
do_free:                                          ; preds = %entry
  %rel_email_ptr = getelementptr inbounds nuw %HasEmail, ptr %0, i32 0, i32 0
  %rel_email = load ptr, ptr %rel_email_ptr, align 8
  %is_null_email = icmp eq ptr %rel_email, null
  br i1 %is_null_email, label %rel_email_skip, label %rel_email_do
...
rel_email_skip:                                   ; preds = %rel_email_do, %do_free
  call void @avra_rc_free(ptr %0)
  br label %done

rel_email_do:                                     ; preds = %do_free
  call void @avra_rc_release(ptr %rel_email)
  br label %rel_email_skip
}
