...
@spec_str = private unnamed_addr constant [22 x i8] c"\22break map iteration\22\00", align 1
@spec_str.6 = private unnamed_addr constant [38 x i8] c"\22map iteration sums values correctly\22\00", align 1
...
entry:
  ...
  call void @forge_map_set_cstr(ptr %0, ptr @.str, i64 ptrtoint (ptr @.str.1 to i64))
  call void @forge_map_set_cstr(ptr %0, ptr @.str.2, i64 ptrtoint (ptr @.str.3 to i64))
  call void @forge_map_set_cstr(ptr %0, ptr @.str.4, i64 ptrtoint (ptr @.str.5 to i64))
  store ptr %0, ptr %m, align 8
  %m1 = load ptr, ptr %m, align 8
  %1 = call ptr @forge_map_keys_cstr(ptr %m1)
  store ptr %1, ptr %keys, align 8
  store i64 0, ptr %count, align 8
  %keys2 = load ptr, ptr %keys, align 8
  %2 = call i64 @forge_array_len(ptr %keys2)
...
forin.body:                                       ; preds = %forin.cond
  %3 = call i64 @forge_array_get(ptr %keys2, i64 %forin_i_val)
  store i64 %3, ptr %k, align 8
  %count3 = load i64, ptr %count, align 8
  %m4 = load ptr, ptr %m, align 8
  %k5 = load ptr, ptr %k, align 8
  %4 = call i64 @forge_map_get_cstr(ptr %m4, ptr %k5)
  %add = add i64 %count3, %4
...
entry:
  ...
  %2 = call i64 @forge_test_run_then(ptr @spec_str.6, i64 %eq_ext)
  %3 = call i32 @forge_test_end_spec(ptr @spec_str)
  %widen1 = sext i32 %3 to i64
  %4 = call i32 @forge_test_summary()
