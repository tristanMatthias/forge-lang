...
@src_file = private unnamed_addr constant [94 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/cli_fmt.av\00", align 1
...
@src_file.3 = private unnamed_addr constant [94 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/cli_fmt.av\00", align 1
...
@mu_file = private unnamed_addr constant [94 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/cli_fmt.av\00", align 1
...
entry:
  ...
  %fld_ptr1 = getelementptr inbounds nuw %Point, ptr %p_copy, i32 0, i32 1
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 1, ptr @sty_name, i64 5, i64 %null_ext, ptr @src_file, i64 93, i64 13)
  %x_ptr = getelementptr inbounds nuw %Point, ptr %p3, i32 0, i32 0
  %x = load i64, ptr %x_ptr, align 8
  %p5 = load ptr, ptr %p, align 8
  %cast6 = ptrtoint ptr %p5 to i64
  %null_chk7 = icmp eq i64 %cast6, 0
  %null_ext8 = zext i1 %null_chk7 to i64
  call void @avra_null_deref_trap(ptr @fld_name.1, i64 1, ptr @sty_name.2, i64 5, i64 %null_ext8, ptr @src_file.3, i64 93, i64 13)
  %y_ptr = getelementptr inbounds nuw %Point, ptr %p5, i32 0, i32 1
  ...
  %tag_ptr = getelementptr inbounds nuw %Color, ptr %4, i32 0, i32 0
  store i64 193469728, ptr %tag_ptr, align 8
  %pay_ptr = getelementptr inbounds nuw %Color, ptr %4, i32 0, i32 1
  store ptr null, ptr %pay_ptr, align 8
  %cast10 = ptrtoint ptr %4 to i64
  %cast11 = inttoptr i64 %cast10 to ptr
  store ptr %cast11, ptr %c, align 8
  %c12 = load ptr, ptr %c, align 8
  %tag_ptr13 = getelementptr inbounds nuw %Color, ptr %c12, i32 0, i32 0
  %tag = load i64, ptr %tag_ptr13, align 8
  %tag_eq = icmp eq i64 %tag, 193469728
  br i1 %tag_eq, label %march_arm, label %march_next

match_end:                                        ; preds = %march_arm19, %march_arm15, %march_arm
  %5 = call i64 @add(i64 10, i64 20)
  store i64 %5, ptr %sum, align 8
  %sum23 = load i64, ptr %sum, align 8
  %6 = call ptr @avra_rc_alloc(i64 32)
  %7 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %6, i64 32, ptr @.i2s_fmt.6, i64 %sum23)
  %widen24 = sext i32 %7 to i64
  %8 = call i32 @puts(ptr %6)
  %widen25 = sext i32 %8 to i64
  store i64 0, ptr %i, align 8
  store i64 3, ptr %for_end, align 8
  br label %for.cond

march_arm:                                        ; preds = %entry
  %9 = call i32 @puts(ptr @.str)
  %widen14 = sext i32 %9 to i64
  store i64 0, ptr %match_stmt_discard, align 8
  br label %match_end

march_next:                                       ; preds = %entry
  %tag_eq17 = icmp eq i64 %tag, 210675960374
