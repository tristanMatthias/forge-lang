...
define ptr @maybe_transform(i64 %0) {
entry:
  %use_double = alloca i64, align 8
  store i64 %0, ptr %use_double, align 8
  %use_double1 = load i64, ptr %use_double, align 8
  %eq = icmp eq i64 %use_double1, 1
...
define i64 @main() {
entry:
  %0 = call ptr @maybe_transform(i64 1)
  store ptr %0, ptr @t1, align 8
  %1 = call ptr @maybe_transform(i64 0)
  store ptr %1, ptr @t2, align 8
  %t1 = load i64, ptr @t1, align 8
  %2 = call i64 @avra_closure_call_1(i64 %t1, i64 5)
  ...
  %6 = call i64 @avra_closure_call_1(i64 %t2, i64 5)
