...
@src_file = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/deep_immutability.av\00", align 1
@.i2s_fmt = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.str = private unnamed_addr constant [10 x i8] c"updated: \00", align 1
...
@src_file.3 = private unnamed_addr constant [104 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/deep_immutability.av\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 1, ptr @sty_name, i64 5, i64 %null_ext, ptr @src_file, i64 103, i64 9)
  ...
  %fld_ptr6 = getelementptr inbounds nuw %Point, ptr %4, i32 0, i32 0
  store i64 1, ptr %fld_ptr6, align 8
  %fld_ptr7 = getelementptr inbounds nuw %Point, ptr %4, i32 0, i32 1
  store i64 2, ptr %fld_ptr7, align 8
  %cast8 = ptrtoint ptr %4 to i64
  %cast9 = inttoptr i64 %cast8 to ptr
  store ptr %cast9, ptr %q, align 8
  %q10 = load ptr, ptr %q, align 8
  %fa_fld = getelementptr inbounds nuw %Point, ptr %q10, i32 0, i32 0
  store i64 99, ptr %fa_fld, align 8
  %q11 = load ptr, ptr %q, align 8
  %cast12 = ptrtoint ptr %q11 to i64
  %null_chk13 = icmp eq i64 %cast12, 0
  %null_ext14 = zext i1 %null_chk13 to i64
  call void @avra_null_deref_trap(ptr @fld_name.1, i64 1, ptr @sty_name.2, i64 5, i64 %null_ext14, ptr @src_file.3, i64 103, i64 14)
  %x_ptr15 = getelementptr inbounds nuw %Point, ptr %q11, i32 0, i32 0
  %x16 = load i64, ptr %x_ptr15, align 8
  %5 = call ptr @avra_rc_alloc(i64 32)
  %6 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %5, i64 32, ptr @.i2s_fmt.4, i64 %x16)
  ...
  %dst2_int = add i64 %cast18, %7
  %cast19 = inttoptr i64 %dst2_int to ptr
  %rhs_len_p1 = add i64 %8, 1
  %11 = call ptr @memcpy(ptr %cast19, ptr %5, i64 %rhs_len_p1)
