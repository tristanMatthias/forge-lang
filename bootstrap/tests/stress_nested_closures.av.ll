...
entry:
  ...
  %add10_20 = alloca ptr, align 8
  %add10 = alloca ptr, align 8
  %1 = call ptr @make_adder(i64 10)
  store ptr %1, ptr %add10, align 8
  %add101 = load i64, ptr %add10, align 8
  %2 = call i64 @avra_closure_call_1(i64 %add101, i64 20)
  %cast = inttoptr i64 %2 to ptr
  store ptr %cast, ptr %add10_20, align 8
  %add10_202 = load i64, ptr %add10_20, align 8
  %3 = call i64 @avra_closure_call_1(i64 %add10_202, i64 30)
  store i64 %3, ptr %result, align 8
  %result3 = load i64, ptr %result, align 8
  %4 = call ptr @avra_rc_alloc(i64 32)
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt, i64 %result3)
...
entry:
  ...
  %cap_val = load i64, ptr %sum, align 8
