...
entry:
  ...
  %users = alloca ptr, align 8
  %1 = call ptr @avra_array_new()
  %2 = call ptr @avra_map_new_cstr()
  call void @avra_map_set_cstr(ptr %2, ptr @.str, i64 ptrtoint (ptr @.str.1 to i64))
  call void @avra_map_set_cstr(ptr %2, ptr @.str.2, i64 30)
  %cast = ptrtoint ptr %2 to i64
  call void @avra_array_push(ptr %1, i64 %cast)
  %3 = call ptr @avra_map_new_cstr()
  call void @avra_map_set_cstr(ptr %3, ptr @.str.3, i64 ptrtoint (ptr @.str.4 to i64))
  call void @avra_map_set_cstr(ptr %3, ptr @.str.5, i64 25)
  %cast1 = ptrtoint ptr %3 to i64
  call void @avra_array_push(ptr %1, i64 %cast1)
  %4 = call ptr @avra_map_new_cstr()
  call void @avra_map_set_cstr(ptr %4, ptr @.str.6, i64 ptrtoint (ptr @.str.7 to i64))
  call void @avra_map_set_cstr(ptr %4, ptr @.str.8, i64 35)
  %cast2 = ptrtoint ptr %4 to i64
  call void @avra_array_push(ptr %1, i64 %cast2)
  store ptr %1, ptr %users, align 8
  %users3 = load ptr, ptr %users, align 8
  %5 = call i64 @avra_array_len(ptr %users3)
  ...
  call void @avra_map_set_cstr(ptr %9, ptr @.str.9, i64 1)
  call void @avra_map_set_cstr(ptr %9, ptr @.str.10, i64 2)
  store ptr %9, ptr %m, align 8
  %m5 = load ptr, ptr %m, align 8
  %10 = call i64 @avra_map_get_cstr(ptr %m5, ptr @.str.11)
  %11 = call ptr @avra_rc_alloc(i64 32)
  %12 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %11, i64 32, ptr @.i2s_fmt.12, i64 %10)
  %widen6 = sext i32 %12 to i64
  %13 = call i32 @puts(ptr %11)
  %widen7 = sext i32 %13 to i64
  %m8 = load ptr, ptr %m, align 8
  %14 = call i64 @avra_map_get_cstr(ptr %m8, ptr @.str.13)
  %15 = call ptr @avra_rc_alloc(i64 32)
  %16 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %15, i64 32, ptr @.i2s_fmt.14, i64 %14)
