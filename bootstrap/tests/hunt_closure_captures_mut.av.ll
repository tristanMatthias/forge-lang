...
entry:
  ...
  store i64 %cast, ptr @snap, align 8
  %snap = load i64, ptr @snap, align 8
  %cast1 = inttoptr i64 %snap to ptr
  ...
  %snap3 = load i64, ptr @snap, align 8
  %cast4 = inttoptr i64 %snap3 to ptr
  %5 = call i64 @avra_array_get(ptr %cast4, i64 1)
  %fn_ptr5 = inttoptr i64 %5 to ptr
  %closure_call6 = call i64 %fn_ptr5(i64 100)
...
entry:
  ...
  %base = load i64, ptr @base, align 8
  %add = add i64 %x1, %base
  ret i64 %add
}
