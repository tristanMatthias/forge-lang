...
entry:
  ...
  store i64 %cast, ptr @transforms, align 8
  ...
  store i64 %cast1, ptr @t2, align 8
  store i64 5, ptr @val, align 8
  %transforms = load i64, ptr @transforms, align 8
  %cast2 = inttoptr i64 %transforms to ptr
  %2 = call i64 @avra_array_get(ptr %cast2, i64 1)
  %fn_ptr = inttoptr i64 %2 to ptr
  %val = load i64, ptr @val, align 8
  %closure_call = call i64 %fn_ptr(i64 %val)
  store i64 %closure_call, ptr @val, align 8
  %t2 = load i64, ptr @t2, align 8
  %cast3 = inttoptr i64 %t2 to ptr
  %3 = call i64 @avra_array_get(ptr %cast3, i64 1)
  %fn_ptr4 = inttoptr i64 %3 to ptr
  %val5 = load i64, ptr @val, align 8
  %closure_call6 = call i64 %fn_ptr4(i64 %val5)
  store i64 %closure_call6, ptr @val, align 8
  %val7 = load i64, ptr @val, align 8
  %4 = call ptr @avra_rc_alloc(i64 32)
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt, i64 %val7)
