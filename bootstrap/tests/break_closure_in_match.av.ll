...
@mu_file = private unnamed_addr constant [109 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/break_closure_in_match.av\00", align 1
...
entry:
  ...
  %cap_val = load i64, ptr %threshold, align 8
...
entry:
  ...
  %0 = call ptr @make_checker(i64 100)
  store ptr %0, ptr @is_big, align 8
  %1 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %1, i64 50)
  call void @avra_array_push(ptr %1, i64 150)
  call void @avra_array_push(ptr %1, i64 75)
  call void @avra_array_push(ptr %1, i64 200)
  store ptr %1, ptr @nums, align 8
  %nums = load ptr, ptr @nums, align 8
  %2 = call i64 @avra_array_len(ptr %nums)
...
forin.body:                                       ; preds = %forin.cond
  %3 = call i64 @avra_array_get(ptr %nums, i64 %forin_i_val)
  store i64 %3, ptr %n, align 8
  %n1 = load i64, ptr %n, align 8
  store i64 0, ptr %pmatch_result, align 8
  %is_big = load i64, ptr @is_big, align 8
  %n2 = load i64, ptr %n, align 8
  %4 = call i64 @avra_closure_call_1(i64 %is_big, i64 %n2)
  %eq = icmp eq i64 %4, 1
...
pmatch_end:                                       ; preds = %parm_body3, %parm_body
  ...
  %7 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %6, i64 32, ptr @.i2s_fmt, i64 %n5)
  %widen = sext i32 %7 to i64
  %8 = call i64 @strlen(ptr %6)
  %9 = call i64 @strlen(ptr @.str.2)
  %concat_total = add i64 %8, %9
  %concat_size = add i64 %concat_total, 1
  %10 = call ptr @avra_rc_alloc(i64 %concat_size)
  %11 = call ptr @memcpy(ptr %10, ptr %6, i64 %8)
  %cast6 = ptrtoint ptr %10 to i64
  %dst2_int = add i64 %cast6, %8
  %cast7 = inttoptr i64 %dst2_int to ptr
  %rhs_len_p1 = add i64 %9, 1
  %12 = call ptr @memcpy(ptr %cast7, ptr @.str.2, i64 %rhs_len_p1)
  %label8 = load ptr, ptr %label, align 8
  %13 = call i64 @strlen(ptr %10)
  %14 = call i64 @strlen(ptr %label8)
  %concat_total9 = add i64 %13, %14
  %concat_size10 = add i64 %concat_total9, 1
  %15 = call ptr @avra_rc_alloc(i64 %concat_size10)
  %16 = call ptr @memcpy(ptr %15, ptr %10, i64 %13)
  %cast11 = ptrtoint ptr %15 to i64
  %dst2_int12 = add i64 %cast11, %13
  %cast13 = inttoptr i64 %dst2_int12 to ptr
  %rhs_len_p114 = add i64 %14, 1
  %17 = call ptr @memcpy(ptr %cast13, ptr %label8, i64 %rhs_len_p114)
...
entry:
  ...
  %threshold2 = load i64, ptr %threshold, align 8
  %sgt = icmp sgt i64 %x1, %threshold2
