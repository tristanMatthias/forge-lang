...
entry:
  ...
  call void @avra_array_set(ptr %nums, i64 1, i64 99)
  %nums1 = load ptr, ptr @nums, align 8
  %1 = call i64 @avra_array_get(ptr %nums1, i64 1)
  ...
  call void @avra_array_set(ptr %nums3, i64 0, i64 77)
  %nums4 = load ptr, ptr @nums, align 8
  %5 = call i64 @avra_array_get(ptr %nums4, i64 0)
  ...
  %9 = call i64 @avra_array_len(ptr %nums7)
