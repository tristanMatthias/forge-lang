...
@.str.1 = private unnamed_addr constant [15 x i8] c"interpolated: \00", align 1
...
entry:
  ...
  %3 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %2, i64 32, ptr @.i2s_fmt, i64 %n2)
