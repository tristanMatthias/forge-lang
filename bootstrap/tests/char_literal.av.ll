...
entry:
  ...
  store i64 65, ptr %a, align 8
  %a1 = load i64, ptr %a, align 8
  %1 = call ptr @avra_rc_alloc(i64 32)
  %2 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %1, i64 32, ptr @.i2s_fmt, i64 %a1)
  %widen = sext i32 %2 to i64
  %3 = call i32 @puts(ptr %1)
  %widen2 = sext i32 %3 to i64
  store i64 122, ptr %z, align 8
  %z3 = load i64, ptr %z, align 8
  %4 = call ptr @avra_rc_alloc(i64 32)
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt.1, i64 %z3)
  %widen4 = sext i32 %5 to i64
  %6 = call i32 @puts(ptr %4)
  %widen5 = sext i32 %6 to i64
  store i64 10, ptr %newline, align 8
  %newline6 = load i64, ptr %newline, align 8
  %7 = call ptr @avra_rc_alloc(i64 32)
  %8 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %7, i64 32, ptr @.i2s_fmt.2, i64 %newline6)
  %widen7 = sext i32 %8 to i64
  %9 = call i32 @puts(ptr %7)
  %widen8 = sext i32 %9 to i64
  store i64 9, ptr %tab, align 8
  %tab9 = load i64, ptr %tab, align 8
  %10 = call ptr @avra_rc_alloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.3, i64 %tab9)
  %widen10 = sext i32 %11 to i64
  %12 = call i32 @puts(ptr %10)
  %widen11 = sext i32 %12 to i64
  store i64 48, ptr %zero, align 8
  %zero12 = load i64, ptr %zero, align 8
  %13 = call ptr @avra_rc_alloc(i64 32)
  %14 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %13, i64 32, ptr @.i2s_fmt.4, i64 %zero12)
