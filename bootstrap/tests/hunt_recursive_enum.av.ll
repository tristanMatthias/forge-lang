...
@my_list = global i64 0
@.match_fn = private unnamed_addr constant [4 x i8] c"sum\00", align 1
@mu_file = private unnamed_addr constant [106 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/hunt_recursive_enum.av\00", align 1
@.str = private unnamed_addr constant [4 x i8] c"nil\00", align 1
@.i2s_fmt = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c" -> \00", align 1
@.match_fn.2 = private unnamed_addr constant [15 x i8] c"list_to_string\00", align 1
@mu_file.3 = private unnamed_addr constant [106 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/tests/hunt_recursive_enum.av\00", align 1
...
define ptr @list_to_string(ptr %0) {
entry:
  %t8 = alloca ptr, align 8
  %h5 = alloca i64, align 8
  %match_result = alloca i64, align 8
...
march_arm2:                                       ; preds = %march_next
  ...
  %2 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %1, i64 32, ptr @.i2s_fmt, i64 %h9)
  ...
  %7 = call ptr @memcpy(ptr %cast10, ptr @.str.1, i64 %rhs_len_p1)
  %t11 = load ptr, ptr %t8, align 8
  %8 = call ptr @list_to_string(ptr %t11)
  %9 = call i64 @strlen(ptr %5)
  %10 = call i64 @strlen(ptr %8)
  %concat_total12 = add i64 %9, %10
  %concat_size13 = add i64 %concat_total12, 1
  %11 = call ptr @avra_rc_alloc(i64 %concat_size13)
  %12 = call ptr @memcpy(ptr %11, ptr %5, i64 %9)
  %cast14 = ptrtoint ptr %11 to i64
  %dst2_int15 = add i64 %cast14, %9
  %cast16 = inttoptr i64 %dst2_int15 to ptr
  %rhs_len_p117 = add i64 %10, 1
  %13 = call ptr @memcpy(ptr %cast16, ptr %8, i64 %rhs_len_p117)
  %cast18 = ptrtoint ptr %11 to i64
  store i64 %cast18, ptr %match_result, align 8
  br label %match_end

march_next3:                                      ; preds = %march_next
  call void @avra_match_unreachable(ptr @.match_fn.2, i64 %tag, ptr @mu_file.3, i64 15)
  unreachable
}
...
entry:
  ...
  store i64 193465512, ptr %tag_ptr11, align 8
  ...
  %slot_base13 = ptrtoint ptr %5 to i64
  ...
  %slot_base18 = ptrtoint ptr %3 to i64
  ...
  %cast22 = ptrtoint ptr %2 to i64
  %slot_base23 = ptrtoint ptr %1 to i64
  ...
  %cast27 = ptrtoint ptr %0 to i64
  store i64 %cast27, ptr @my_list, align 8
  %my_list = load ptr, ptr @my_list, align 8
  %7 = call ptr @list_to_string(ptr %my_list)
  %8 = call i32 @puts(ptr %7)
  %widen = sext i32 %8 to i64
  %my_list28 = load ptr, ptr @my_list, align 8
  %9 = call i64 @sum(ptr %my_list28)
  ...
  %widen30 = sext i32 %12 to i64
  %13 = call i32 @avra_test_summary()
  %widen31 = sext i32 %13 to i64
