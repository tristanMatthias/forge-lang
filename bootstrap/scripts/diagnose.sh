...
fn pat_imports_block() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, capval_to_pat, capval_to_pat_list, capval_tok_text, pat_num_node, pat_bool_node, pat_str_node, ident_pat_bare, param_entries_from_toks, run_grammar_pat, text_is_word, _gb_build_defer, _gb_build_errdefer}\n" +
    "use @std.avrac.parse.{parser_new}\n" +
    "use @std.avrac.features.match.{avra_pat_grammar}\n" +
...
fn type_imports_block() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, capval_to_texpr, capval_to_texpr_list, capval_present, capval_tok_text, lookahead_ok, fold_type_union, mk_named_type, mk_splice_type, mk_qualified_type, mk_paren_type, mk_fn_type, mk_dyn_type, text_is_word, _gb_build_defer, _gb_build_errdefer}\n" +
    "use @std.avrac.parse.{parser_new}\n" +
