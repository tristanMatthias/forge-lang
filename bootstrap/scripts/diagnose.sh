...
use @std.avrac.features.grammar.{avra_expr_grammar, avra_stmt_flip_grammar, avra_type_grammar, avra_program_grammar, emit_parser_source, grammar_with_builder_kinds, builder_kind_rows, derived_import_lines}
...
fn grammar_core_imports() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, dump_expr}\n"
}
...
fn pat_imports_block() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, capval_to_pat, run_grammar_pat}\n" +
    "use @std.avrac.parse.{parser_new}\n" +
    "use @std.avrac.features.match.{avra_pat_grammar}\n" +
...
fn type_imports_block() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, capval_to_texpr}\n" +
    "use @std.avrac.parse.{parser_new}\n" +
...
fn program_imports_block() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, capval_to_stmt}\n" +
...
fn main() {
    ...
    let expr_parser = emit_parser_source(grammar_with_builder_kinds(avra_expr_grammar(), rows))
    let _ = avra_selfhost_write_file("build/emit_gen/generated_parser.av", assemble(imports_block(), expr_parser, harness_block()))
    let stmt_parser = emit_parser_source(grammar_with_builder_kinds(avra_stmt_flip_grammar(), rows))
    let _ = avra_selfhost_write_file("build/emit_gen/generated_stmt_parser.av", assemble(stmt_imports_block(), stmt_parser, stmt_harness_block()))
    let pat_parser = emit_parser_source(grammar_with_builder_kinds(avra_pat_grammar(), rows))
    let _ = avra_selfhost_write_file("build/emit_gen/generated_pat_parser.av", assemble(pat_imports_block(), pat_parser, pat_harness_block()))
    let type_parser = emit_parser_source(grammar_with_builder_kinds(avra_type_grammar(), rows))
    let _ = avra_selfhost_write_file("build/emit_gen/generated_type_parser.av", assemble(type_imports_block(), type_parser, type_harness_block()))
    let prog_parser = emit_parser_source(grammar_with_builder_kinds(avra_program_grammar(), rows))
    let _ = avra_selfhost_write_file("build/emit_gen/generated_program_parser.av", assemble(program_imports_block(), prog_parser, program_harness_block()))
