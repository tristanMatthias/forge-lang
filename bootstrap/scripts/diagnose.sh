...
use @std.avrac.features.grammar.{avra_expr_grammar, avra_stmt_grammar, avra_type_grammar, avra_program_grammar, emit_parser_source, grammar_with_builder_kinds, builder_kind_rows}
...
fn main() {
    ...
    let stmt_src = stmt_imports_block() + emit_parser_source(grammar_with_builder_kinds(avra_stmt_grammar(), rows)) + "\n" + stmt_harness_block()
