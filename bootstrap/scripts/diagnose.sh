...
fn program_imports_block() -> string {
    "use @std.avrac.features.grammar.{Token, CapVal, PState, new_pstate, capval_to_expr, capval_to_stmt, capval_to_texpr, capval_to_pentry, capval_to_field, capval_to_variant, capval_tok_text, capval_present, run_hand, run_hand_stmt, run_hand_type, run_hand_expr, literal_node, mk_binary, fold_binary_expr, fold_logical_expr, fold_nullish_expr, fold_postfix_expr, unary_expr, mk_assign_expr, fold_pipe_expr, rebind_eq_expr, mk_is_expr, mk_inlist_expr, mk_inrange_expr, mk_eqchain_expr, tok_starts_expr_leaf, fold_type_union, mk_named_type, mk_paren_type, mk_fn_type, mk_block, mk_while, mk_if, mk_for_loop, mk_return_opt, mk_fn_decl, mk_type_decl, mk_enum_decl, mk_trait_decl, mk_impl, mk_use, mk_module, mk_field, mk_evariant, mk_param, mk_assoc_type, mk_trait_method, mk_method}\n" +
