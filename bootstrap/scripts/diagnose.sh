...
fn stmt_imports_block() -> string {
    ...
    "use @std.avrac.core.{Expr, ExprId, Stmt, StmtId, Pattern, PatId, ParamEntry, MatchArm, SelectArm, ValueType, Tk, NodeStore, render_stmt_id, pattern_optional_present, pattern_optional_absent}\n\n"
}
