; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/let_stmt/tests/shadowing.fg.ll'
...
entry:
  ...
  %x3 = load i64, ptr %x2, align 8
  %15 = call ptr @forge_rc_alloc(i64 32)
  %16 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %15, i64 32, ptr @.i2s_fmt.1, i64 %x3)
  %widen4 = sext i32 %16 to i64
  %17 = call i32 @puts(ptr %15)
  %widen5 = sext i32 %17 to i64
  %pgocount12 = load i64, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 12), align 8
  %18 = add i64 %pgocount12, 1
  store i64 %18, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 12), align 8
  %pgocount13 = load i64, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 13), align 8
  %19 = add i64 %pgocount13, 1
  store i64 %19, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 13), align 8
  ...
  store i64 %24, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 18), align 8
  %x7 = load i64, ptr %x6, align 8
  %25 = call ptr @forge_rc_alloc(i64 32)
  %26 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %25, i64 32, ptr @.i2s_fmt.2, i64 %x7)
  ...
  %x10 = load i64, ptr %x2, align 8
  %32 = call ptr @forge_rc_alloc(i64 32)
  %33 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %32, i64 32, ptr @.i2s_fmt.3, i64 %x10)
  %widen11 = sext i32 %33 to i64
  %34 = call i32 @puts(ptr %32)
  %widen12 = sext i32 %34 to i64
  %pgocount23 = load i64, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 23), align 8
  %35 = add i64 %pgocount23, 1
  store i64 %35, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 23), align 8
  %pgocount24 = load i64, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 24), align 8
  %36 = add i64 %pgocount24, 1
  store i64 %36, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 24), align 8
  %pgocount25 = load i64, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 25), align 8
  %37 = add i64 %pgocount25, 1
  store i64 %37, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 25), align 8
  %pgocount26 = load i64, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 26), align 8
  %38 = add i64 %pgocount26, 1
  store i64 %38, ptr getelementptr inbounds ([27 x i64], ptr @__profc_main, i32 0, i32 26), align 8
  %x13 = load i64, ptr @x, align 8
  %39 = call ptr @forge_rc_alloc(i64 32)
  %40 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %39, i64 32, ptr @.i2s_fmt.4, i64 %x13)
  %widen14 = sext i32 %40 to i64
  %41 = call i32 @puts(ptr %39)
  %widen15 = sext i32 %41 to i64
  %42 = call i32 @forge_test_summary()
  %widen16 = sext i32 %42 to i64
