...
@dz_file = private unnamed_addr constant [143 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/avrac/src/features/for_stmt/tests/forin_comprehensive.av\00", align 1
...
forin.body65:                                     ; preds = %forin.cond64
  ...
  call void @avra_div_by_zero_trap(i64 0, ptr @dz_file, i64 142, i64 40)
  %mod = srem i64 %n71, 2
