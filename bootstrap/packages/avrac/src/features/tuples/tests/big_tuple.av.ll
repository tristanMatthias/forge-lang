...
define i64 @main() {
entry:
  %0 = call ptr @avra_rc_alloc(i64 64)
  ...
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt.1, i64 %tup_val32)
  %widen33 = sext i32 %5 to i64
  %6 = call i32 @puts(ptr %4)
  %widen34 = sext i32 %6 to i64
  %7 = call i32 @avra_test_summary()
  %widen35 = sext i32 %7 to i64
