...
entry:
  ...
  %slot_base16 = ptrtoint ptr %4 to i64
  ...
  %6 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %5, i64 32, ptr @.i2s_fmt.1, i64 %add28)
  %widen29 = sext i32 %6 to i64
  %7 = call i32 @puts(ptr %5)
  %widen30 = sext i32 %7 to i64
  %8 = call i32 @avra_test_summary()
  %widen31 = sext i32 %8 to i64
