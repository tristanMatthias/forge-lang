...
@src_file = private unnamed_addr constant [138 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/avrac/src/features/if_stmt/tests/if_expr_complex.av\00", align 1
...
@src_file.7 = private unnamed_addr constant [138 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/avrac/src/features/if_stmt/tests/if_expr_complex.av\00", align 1
...
ife_end21:                                        ; preds = %ife_else23, %ife_then22
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 1, ptr @sty_name, i64 4, i64 %null_ext, ptr @src_file, i64 137, i64 14)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.5, i64 1, ptr @sty_name.6, i64 4, i64 %null_ext33, ptr @src_file.7, i64 137, i64 15)
