...
entry:
  ...
  %2 = call ptr @find(ptr %a1)
  %try_null = icmp eq ptr %2, null
  br i1 %try_null, label %try_ret, label %try_ok

try_ok:                                           ; preds = %entry
  store ptr %2, ptr %name_a, align 8
  %b2 = load ptr, ptr %b, align 8
  %3 = call ptr @find(ptr %b2)
  %try_null3 = icmp eq ptr %3, null
...
try_ok4:                                          ; preds = %try_ok
  store ptr %3, ptr %name_b, align 8
  ...
  %slot_base8 = ptrtoint ptr %4 to i64
...
entry:
  ...
  %0 = call i64 @greet_pair(ptr @.str.2, ptr @.str.3)
...
nc_end:                                           ; preds = %nc_rhs, %entry
  ...
  %4 = call i64 @greet_pair(ptr @.str.4, ptr @.str.5)
...
nc_end4:                                          ; preds = %nc_rhs3, %nc_end
  ...
  %6 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %5, i64 32, ptr @.i2s_fmt.6, i64 %nc_val6)
