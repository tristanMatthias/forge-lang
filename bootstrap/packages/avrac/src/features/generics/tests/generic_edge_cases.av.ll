...
@src_file = private unnamed_addr constant [142 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/avrac/src/features/generics/tests/generic_edge_cases.av\00", align 1
...
@src_file.7 = private unnamed_addr constant [142 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/avrac/src/features/generics/tests/generic_edge_cases.av\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 5, ptr @sty_name, i64 17, i64 %null_ext, ptr @src_file, i64 141, i64 42)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.5, i64 6, ptr @sty_name.6, i64 17, i64 %null_ext11, ptr @src_file.7, i64 141, i64 42)
