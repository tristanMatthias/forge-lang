...
entry:
  ...
  %tag_ptr2 = getelementptr inbounds nuw %Color, ptr %1, i32 0, i32 0
  store i64 210675960374, ptr %tag_ptr2, align 8
  %pay_ptr3 = getelementptr inbounds nuw %Color, ptr %1, i32 0, i32 1
  ...
  %tag_ptr6 = getelementptr inbounds nuw %Color, ptr %2, i32 0, i32 0
  store i64 6383934317, ptr %tag_ptr6, align 8
  %pay_ptr7 = getelementptr inbounds nuw %Color, ptr %2, i32 0, i32 1
  ...
  %3 = call ptr @Color__name(ptr %r10)
  ...
  %5 = call ptr @Color__name(ptr %g12)
  ...
  %7 = call ptr @Color__name(ptr %b17)
