...
@src_file = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/impl_decl/example.av\00", align 1
...
@src_file.3 = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/impl_decl/example.av\00", align 1
...
@src_file.6 = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/impl_decl/example.av\00", align 1
...
@src_file.9 = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/impl_decl/example.av\00", align 1
...
@src_file.12 = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/impl_decl/example.av\00", align 1
...
@src_file.15 = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/impl_decl/example.av\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 5, ptr @sty_name, i64 7, i64 %null_ext, ptr @src_file, i64 126, i64 9)
...
entry:
  ...
  %null_chk = icmp eq i64 %cast, 0
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name.1, i64 5, ptr @sty_name.2, i64 7, i64 %null_ext, ptr @src_file.3, i64 126, i64 13)
...
entry:
  ...
  %null_ext = zext i1 %null_chk to i64
  call void @avra_null_deref_trap(ptr @fld_name.4, i64 9, ptr @sty_name.5, i64 7, i64 %null_ext, ptr @src_file.6, i64 126, i64 19)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.7, i64 9, ptr @sty_name.8, i64 7, i64 %null_ext7, ptr @src_file.9, i64 126, i64 20)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.10, i64 9, ptr @sty_name.11, i64 7, i64 %null_ext11, ptr @src_file.12, i64 126, i64 21)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.13, i64 5, ptr @sty_name.14, i64 7, i64 %null_ext15, ptr @src_file.15, i64 126, i64 22)
