...
@mu_file = private unnamed_addr constant [137 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/match_expr/tests/enum_match.av\00", align 1
...
entry:
  ...
  %tag_ptr2 = getelementptr inbounds nuw %Color, ptr %4, i32 0, i32 0
  store i64 210675960374, ptr %tag_ptr2, align 8
  %pay_ptr3 = getelementptr inbounds nuw %Color, ptr %4, i32 0, i32 1
  store ptr null, ptr %pay_ptr3, align 8
  %cast4 = ptrtoint ptr %4 to i64
  %cast5 = inttoptr i64 %cast4 to ptr
  %5 = call ptr @describe(ptr %cast5)
  %6 = call i32 @puts(ptr %5)
  %widen6 = sext i32 %6 to i64
  %7 = call ptr @avra_rc_alloc(i64 16)
  %tag_ptr7 = getelementptr inbounds nuw %Color, ptr %7, i32 0, i32 0
  store i64 6383934317, ptr %tag_ptr7, align 8
  %pay_ptr8 = getelementptr inbounds nuw %Color, ptr %7, i32 0, i32 1
  ...
  %9 = call ptr @describe(ptr %cast10)
