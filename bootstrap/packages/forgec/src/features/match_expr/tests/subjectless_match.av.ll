...
@dz_file = private unnamed_addr constant [144 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/match_expr/tests/subjectless_match.av\00", align 1
@.str.4 = private unnamed_addr constant [9 x i8] c"fizzbuzz\00", align 1
@dz_file.5 = private unnamed_addr constant [144 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/match_expr/tests/subjectless_match.av\00", align 1
@.str.6 = private unnamed_addr constant [5 x i8] c"fizz\00", align 1
@dz_file.7 = private unnamed_addr constant [144 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/match_expr/tests/subjectless_match.av\00", align 1
...
entry:
  ...
  store i64 0, ptr %when_result, align 8
  %n1 = load i64, ptr %n, align 8
  call void @avra_div_by_zero_trap(i64 0, ptr @dz_file, i64 143, i64 24)
  %mod = srem i64 %n1, 15
...
when_next:                                        ; preds = %entry
  %n2 = load i64, ptr %n, align 8
  call void @avra_div_by_zero_trap(i64 0, ptr @dz_file.5, i64 143, i64 24)
  %mod3 = srem i64 %n2, 3
...
when_next8:                                       ; preds = %when_next
  ...
  call void @avra_div_by_zero_trap(i64 0, ptr @dz_file.7, i64 143, i64 24)
  %mod10 = srem i64 %n9, 5
