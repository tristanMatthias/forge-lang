...
entry:
  ...
  %cast1 = inttoptr i64 %cast to ptr
  %1 = call i64 @apply(ptr %cast1, i64 7)
  ...
  call void @avra_array_push(ptr %5, i64 ptrtoint (ptr @__lambda_3 to i64))
  ...
  %8 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %7, i64 32, ptr @.i2s_fmt.1, i64 %closure_call)
  %widen5 = sext i32 %8 to i64
  %9 = call i32 @puts(ptr %7)
  %widen6 = sext i32 %9 to i64
  %10 = call ptr @make_adder(i64 10)
  store ptr %10, ptr @add10, align 8
  %add10 = load i64, ptr @add10, align 8
  %11 = call i64 @avra_closure_call_1(i64 %add10, i64 5)
  ...
  %15 = call i64 @avra_closure_call_1(i64 %add109, i64 20)
  %16 = call ptr @avra_rc_alloc(i64 32)
  %17 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %16, i64 32, ptr @.i2s_fmt.3, i64 %15)
  ...
  %fld_ptr = getelementptr inbounds nuw %Handler, ptr %26, i32 0, i32 0
  store ptr @.str, ptr %fld_ptr, align 8
  %27 = call ptr @avra_array_new()
  call void @avra_array_push(ptr %27, i64 -559038737)
  call void @avra_array_push(ptr %27, i64 ptrtoint (ptr @__lambda_6 to i64))
  %cast17 = ptrtoint ptr %27 to i64
  %fld_ptr18 = getelementptr inbounds nuw %Handler, ptr %26, i32 0, i32 1
  %cast19 = inttoptr i64 %cast17 to ptr
  store ptr %cast19, ptr %fld_ptr18, align 8
  %cast20 = ptrtoint ptr %26 to i64
  ...
  %28 = call i64 @avra_closure_call_1(i64 %fn_field_val, i64 7)
