; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/fn_decl/example.fg.ll'
...
@__profc_greet = private global [6 x i64] zeroinitializer, section "__DATA,__llvm_prf_cnts", align 8
@__profd_greet = private global { i64, i64, i64, i64, ptr, ptr, i32, [3 x i16], i32 } { i64 7134157818277131895, i64 210713909852, i64 sub (i64 ptrtoint (ptr @__profc_greet to i64), i64 ptrtoint (ptr @__profd_greet to i64)), i64 0, ptr null, ptr null, i32 6, [3 x i16] zeroinitializer, i32 0 }, section "__DATA,__llvm_prf_data,regular,live_support", align 8
...
@__llvm_prf_nm = private constant [24 x i8] c"\0E\16x\DAKLIaL/JM-a\CCM\CC\CC\03\00#\F2\04\E8", section "__DATA,__llvm_prf_names", align 1
@llvm.compiler.used = appending global [4 x ptr] [ptr @__llvm_profile_runtime_user, ptr @__profd_add, ptr @__profd_greet, ptr @__profd_main], section "llvm.metadata"
...
entry:
  ...
  %pgocount1 = load i64, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 1), align 8
  %2 = add i64 %pgocount1, 1
  store i64 %2, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 1), align 8
  %pgocount2 = load i64, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 2), align 8
  %3 = add i64 %pgocount2, 1
  store i64 %3, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 2), align 8
  %pgocount3 = load i64, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 3), align 8
  %4 = add i64 %pgocount3, 1
  store i64 %4, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 3), align 8
  %pgocount4 = load i64, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 4), align 8
  %5 = add i64 %pgocount4, 1
  store i64 %5, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 4), align 8
  %pgocount5 = load i64, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 5), align 8
  %6 = add i64 %pgocount5, 1
  store i64 %6, ptr getelementptr inbounds ([6 x i64], ptr @__profc_greet, i32 0, i32 5), align 8
  %name1 = load ptr, ptr %name, align 8
  %7 = call i64 @strlen(ptr @.str)
  %8 = call i64 @strlen(ptr %name1)
  ...
  %11 = call ptr @memcpy(ptr %cast2, ptr %name1, i64 %rhs_len_p1)
  ret ptr %9
}
...
entry:
  ...
  store i64 %6, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 6), align 8
  %7 = call i64 @add(i64 3, i64 4)
  %8 = call ptr @forge_rc_alloc(i64 32)
  %9 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %8, i64 32, ptr @.i2s_fmt, i64 %7)
  ...
  store i64 %11, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 7), align 8
  %pgocount8 = load i64, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 8), align 8
  %12 = add i64 %pgocount8, 1
  store i64 %12, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 8), align 8
  %pgocount9 = load i64, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 9), align 8
  %13 = add i64 %pgocount9, 1
  store i64 %13, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 9), align 8
  %pgocount10 = load i64, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 10), align 8
  %14 = add i64 %pgocount10, 1
  store i64 %14, ptr getelementptr inbounds ([11 x i64], ptr @__profc_main, i32 0, i32 10), align 8
  %15 = call ptr @greet(ptr @.str.1)
