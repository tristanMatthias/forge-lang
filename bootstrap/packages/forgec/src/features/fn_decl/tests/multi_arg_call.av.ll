...
entry:
  ...
  %12 = call ptr @memcpy(ptr %cast9, ptr %suffix4, i64 %rhs_len_p110)
  ret ptr %10
}
...
entry:
  ...
  %1 = call i64 @add3(i64 1, i64 2, i64 3)
  ...
  %5 = call i64 @add3(i64 10, i64 20, i64 30)
  ...
  %9 = call ptr @greet(ptr @.str, ptr @.str.2, ptr @.str.3)
