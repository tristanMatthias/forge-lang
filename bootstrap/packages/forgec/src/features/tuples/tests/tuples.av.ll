...
entry:
  ...
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt.1, i64 %tup_val9)
  ...
  %slot_base15 = ptrtoint ptr %7 to i64
  ...
  %9 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %8, i64 32, ptr @.i2s_fmt.2, i64 %add36)
  %widen37 = sext i32 %9 to i64
  %10 = call i32 @puts(ptr %8)
  %widen38 = sext i32 %10 to i64
  %11 = call ptr @avra_rc_alloc(i64 16)
  %slot_base39 = ptrtoint ptr %11 to i64
  ...
  %13 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %12, i64 32, ptr @.i2s_fmt.3, i64 %x49)
  %widen50 = sext i32 %13 to i64
  %14 = call i32 @puts(ptr %12)
  %widen51 = sext i32 %14 to i64
  %y52 = load i64, ptr %y48, align 8
  %15 = call ptr @avra_rc_alloc(i64 32)
  %16 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %15, i64 32, ptr @.i2s_fmt.4, i64 %y52)
  %widen53 = sext i32 %16 to i64
  %17 = call i32 @puts(ptr %15)
  %widen54 = sext i32 %17 to i64
  %18 = call ptr @avra_rc_alloc(i64 16)
  %slot_base55 = ptrtoint ptr %18 to i64
  %slot_addr56 = add i64 %slot_base55, 0
  %slot57 = inttoptr i64 %slot_addr56 to ptr
  store i64 42, ptr %slot57, align 8
  %slot_base58 = ptrtoint ptr %18 to i64
  ...
  %20 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %19, i64 32, ptr @.i2s_fmt.5, i64 %tup_val65)
  %widen66 = sext i32 %20 to i64
  %21 = call i32 @puts(ptr %19)
  %widen67 = sext i32 %21 to i64
  ...
  %22 = call i32 @puts(ptr %cast73)
  %widen74 = sext i32 %22 to i64
  %23 = call i32 @avra_test_summary()
  %widen75 = sext i32 %23 to i64
