; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/tuples/tests/tuple_for.fg.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  store i64 %6, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 6), align 8
  %pgocount7 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 7), align 8
  %7 = add i64 %pgocount7, 1
  store i64 %7, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 7), align 8
  ...
  store i64 %mul, ptr %slot7, align 8
  %cast = ptrtoint ptr %8 to i64
  %cast8 = inttoptr i64 %cast to ptr
  store ptr %cast8, ptr %pair, align 8
  ...
  store i64 %18, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 17), align 8
  %pair9 = load ptr, ptr %pair, align 8
  %tup_val_slot_base = ptrtoint ptr %pair9 to i64
  %tup_val_slot_addr = add i64 %tup_val_slot_base, 8
  %tup_val_slot = inttoptr i64 %tup_val_slot_addr to ptr
  %tup_val = load i64, ptr %tup_val_slot, align 8
  %add = add i64 %sum, %tup_val
  store i64 %add, ptr @sum, align 8
  br label %for.incr

for.incr:                                         ; preds = %for.body
  %i10 = load i64, ptr %i, align 8
  %for_next = add i64 %i10, 1
