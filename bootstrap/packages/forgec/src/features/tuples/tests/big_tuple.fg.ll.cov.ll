; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/tuples/tests/big_tuple.fg.ll'
...
entry:
  ...
  %1 = call ptr @forge_rc_alloc(i64 64)
  %pgocount1 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 1), align 8
  %2 = add i64 %pgocount1, 1
  store i64 %2, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 1), align 8
  ...
  %slot_base7 = ptrtoint ptr %1 to i64
  ...
  %slot_base10 = ptrtoint ptr %1 to i64
  ...
  %slot_base13 = ptrtoint ptr %1 to i64
  ...
  %slot_base16 = ptrtoint ptr %1 to i64
  ...
  %slot_base19 = ptrtoint ptr %1 to i64
  ...
  store i64 %16, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 15), align 8
  %pgocount16 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 16), align 8
  %17 = add i64 %pgocount16, 1
  store i64 %17, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 16), align 8
  %big22 = load ptr, ptr @big, align 8
  %tup_val_slot_base23 = ptrtoint ptr %big22 to i64
  %tup_val_slot_addr24 = add i64 %tup_val_slot_base23, 56
  %tup_val_slot25 = inttoptr i64 %tup_val_slot_addr24 to ptr
  %tup_val26 = load i64, ptr %tup_val_slot25, align 8
  %add = add i64 %tup_val, %tup_val26
  %18 = call ptr @forge_rc_alloc(i64 32)
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt, i64 %add)
  ...
  store i64 %21, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 17), align 8
  %pgocount18 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 18), align 8
  %22 = add i64 %pgocount18, 1
  store i64 %22, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 18), align 8
  %pgocount19 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 19), align 8
  %23 = add i64 %pgocount19, 1
  store i64 %23, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 19), align 8
  %pgocount20 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 20), align 8
  %24 = add i64 %pgocount20, 1
  store i64 %24, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 20), align 8
  %pgocount21 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 21), align 8
  %25 = add i64 %pgocount21, 1
  store i64 %25, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 21), align 8
  %big28 = load ptr, ptr @big, align 8
  %tup_val_slot_base29 = ptrtoint ptr %big28 to i64
  %tup_val_slot_addr30 = add i64 %tup_val_slot_base29, 24
  %tup_val_slot31 = inttoptr i64 %tup_val_slot_addr30 to ptr
  %tup_val32 = load i64, ptr %tup_val_slot31, align 8
  %26 = call ptr @forge_rc_alloc(i64 32)
  %27 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %26, i64 32, ptr @.i2s_fmt.1, i64 %tup_val32)
  %widen33 = sext i32 %27 to i64
  %28 = call i32 @puts(ptr %26)
  %widen34 = sext i32 %28 to i64
