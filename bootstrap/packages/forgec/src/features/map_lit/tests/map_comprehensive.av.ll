...
entry:
  ...
  %1 = call i64 @avra_map_len_cstr(ptr %m)
  ...
  %5 = call i64 @avra_map_get_cstr(ptr %m2, ptr @.str.6)
  %cast = inttoptr i64 %5 to ptr
  %6 = call i32 @puts(ptr %cast)
  %widen3 = sext i32 %6 to i64
  %m4 = load ptr, ptr @m, align 8
  %7 = call i64 @avra_map_get_cstr(ptr %m4, ptr @.str.7)
  %cast5 = inttoptr i64 %7 to ptr
  %8 = call i32 @puts(ptr %cast5)
  %widen6 = sext i32 %8 to i64
  %m7 = load ptr, ptr @m, align 8
  %9 = call i64 @avra_map_has_cstr(ptr %m7, ptr @.str.8)
  %10 = call ptr @avra_rc_alloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.9, i64 %9)
  %widen8 = sext i32 %11 to i64
  %12 = call i32 @puts(ptr %10)
  %widen9 = sext i32 %12 to i64
  %m10 = load ptr, ptr @m, align 8
  %13 = call i64 @avra_map_has_cstr(ptr %m10, ptr @.str.10)
  %14 = call ptr @avra_rc_alloc(i64 32)
  %15 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %14, i64 32, ptr @.i2s_fmt.11, i64 %13)
  %widen11 = sext i32 %15 to i64
  %16 = call i32 @puts(ptr %14)
  %widen12 = sext i32 %16 to i64
  %m13 = load ptr, ptr @m, align 8
  call void @avra_map_set_cstr(ptr %m13, ptr @.str.12, i64 ptrtoint (ptr @.str.13 to i64))
  %m14 = load ptr, ptr @m, align 8
  %17 = call i64 @avra_map_get_cstr(ptr %m14, ptr @.str.14)
  %cast15 = inttoptr i64 %17 to ptr
  %18 = call i32 @puts(ptr %cast15)
  %widen16 = sext i32 %18 to i64
  %19 = call ptr @avra_map_new_cstr()
  store ptr %19, ptr @e, align 8
  %e = load ptr, ptr @e, align 8
  %20 = call i64 @avra_map_len_cstr(ptr %e)
  %21 = call ptr @avra_rc_alloc(i64 32)
  %22 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %21, i64 32, ptr @.i2s_fmt.15, i64 %20)
  %widen17 = sext i32 %22 to i64
  %23 = call i32 @puts(ptr %21)
  %widen18 = sext i32 %23 to i64
  %e19 = load ptr, ptr @e, align 8
  %24 = call i64 @avra_map_has_cstr(ptr %e19, ptr @.str.16)
  %25 = call ptr @avra_rc_alloc(i64 32)
  %26 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %25, i64 32, ptr @.i2s_fmt.17, i64 %24)
  %widen20 = sext i32 %26 to i64
  %27 = call i32 @puts(ptr %25)
  %widen21 = sext i32 %27 to i64
  %m22 = load ptr, ptr @m, align 8
  %28 = call ptr @avra_map_keys_cstr(ptr %m22)
  store ptr %28, ptr @k, align 8
  %k = load ptr, ptr @k, align 8
  %29 = call i64 @avra_array_len(ptr %k)
  ...
  %33 = call ptr @avra_map_new_cstr()
  call void @avra_map_set_cstr(ptr %33, ptr @.str.19, i64 1)
  call void @avra_map_set_cstr(ptr %33, ptr @.str.20, i64 2)
  call void @avra_map_set_cstr(ptr %33, ptr @.str.21, i64 3)
  store ptr %33, ptr @nums, align 8
  %nums = load ptr, ptr @nums, align 8
  %34 = call i64 @avra_map_get_cstr(ptr %nums, ptr @.str.22)
  %nums25 = load ptr, ptr @nums, align 8
  %35 = call i64 @avra_map_get_cstr(ptr %nums25, ptr @.str.23)
  %add = add i64 %34, %35
  %nums26 = load ptr, ptr @nums, align 8
  %36 = call i64 @avra_map_get_cstr(ptr %nums26, ptr @.str.24)
  %add27 = add i64 %add, %36
  store i64 %add27, ptr @sum, align 8
  %sum = load i64, ptr @sum, align 8
  %37 = call ptr @avra_rc_alloc(i64 32)
  %38 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %37, i64 32, ptr @.i2s_fmt.25, i64 %sum)
  %widen28 = sext i32 %38 to i64
  %39 = call i32 @puts(ptr %37)
  %widen29 = sext i32 %39 to i64
  %40 = call i32 @avra_test_summary()
  %widen30 = sext i32 %40 to i64
