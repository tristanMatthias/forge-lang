...
entry:
  ...
  %9 = call i64 @avra_map_has_cstr(ptr %m7, ptr @.str.7)
  %10 = call ptr @avra_rc_alloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.8, i64 %9)
  %widen8 = sext i32 %11 to i64
  %12 = call i32 @puts(ptr %10)
  %widen9 = sext i32 %12 to i64
  %m10 = load ptr, ptr @m, align 8
  %13 = call i64 @avra_map_len_cstr(ptr %m10)
  ...
  call void @avra_map_set_cstr(ptr %m13, ptr @.str.10, i64 ptrtoint (ptr @.str.11 to i64))
  %m14 = load ptr, ptr @m, align 8
  %17 = call i64 @avra_map_get_cstr(ptr %m14, ptr @.str.12)
  %cast15 = inttoptr i64 %17 to ptr
  %18 = call i32 @puts(ptr %cast15)
  %widen16 = sext i32 %18 to i64
  %m17 = load ptr, ptr @m, align 8
  %19 = call i64 @avra_map_len_cstr(ptr %m17)
  %20 = call ptr @avra_rc_alloc(i64 32)
  %21 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %20, i64 32, ptr @.i2s_fmt.13, i64 %19)
  %widen18 = sext i32 %21 to i64
  %22 = call i32 @puts(ptr %20)
  %widen19 = sext i32 %22 to i64
  %m20 = load ptr, ptr @m, align 8
  %23 = call ptr @avra_map_keys_cstr(ptr %m20)
  store ptr %23, ptr @keys, align 8
  %keys = load ptr, ptr @keys, align 8
  %24 = call i64 @avra_array_len(ptr %keys)
  %25 = call ptr @avra_rc_alloc(i64 32)
  %26 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %25, i64 32, ptr @.i2s_fmt.14, i64 %24)
  %widen21 = sext i32 %26 to i64
  %27 = call i32 @puts(ptr %25)
  %widen22 = sext i32 %27 to i64
  %28 = call ptr @avra_map_new_cstr()
  store ptr %28, ptr @empty, align 8
  %empty = load ptr, ptr @empty, align 8
  %29 = call i64 @avra_map_len_cstr(ptr %empty)
  %30 = call ptr @avra_rc_alloc(i64 32)
  %31 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %30, i64 32, ptr @.i2s_fmt.15, i64 %29)
