...
nc_end:                                           ; preds = %nc_rhs, %entry
  ...
  %1 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %0, i64 32, ptr @.i2s_fmt, i64 %y)
...
nc_end3:                                          ; preds = %nc_rhs2, %nc_end
  ...
  %4 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %3, i64 32, ptr @.i2s_fmt.1, i64 %z)
