...
@mu_file = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/enum_decl/example.av\00", align 1
...
entry:
  ...
  %tag_ptr = getelementptr inbounds nuw %Option, ptr %1, i32 0, i32 0
  store i64 6384548249, ptr %tag_ptr, align 8
  %pay_ptr = getelementptr inbounds nuw %Option, ptr %1, i32 0, i32 1
  ...
  %tag_ptr2 = getelementptr inbounds nuw %Option, ptr %3, i32 0, i32 0
  store i64 6384368597, ptr %tag_ptr2, align 8
  %pay_ptr3 = getelementptr inbounds nuw %Option, ptr %3, i32 0, i32 1
  ...
  %8 = call i64 @unwrap_or(ptr %b8, i64 -1)
