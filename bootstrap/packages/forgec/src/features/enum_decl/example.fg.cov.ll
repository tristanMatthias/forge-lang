; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/enum_decl/example.fg.ll'
...
@mu_file = private unnamed_addr constant [127 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/enum_decl/example.fg\00", align 1
@.i2s_fmt = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.i2s_fmt.1 = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@__llvm_profile_runtime = external hidden global i32
@__profc_unwrap_or = private global [7 x i64] zeroinitializer, section "__DATA,__llvm_prf_cnts", align 8
@__profd_unwrap_or = private global { i64, i64, i64, i64, ptr, ptr, i32, [3 x i16], i32 } { i64 7128226541967680336, i64 249909593669260386, i64 sub (i64 ptrtoint (ptr @__profc_unwrap_or to i64), i64 ptrtoint (ptr @__profd_unwrap_or to i64)), i64 0, ptr null, ptr null, i32 7, [3 x i16] zeroinitializer, i32 0 }, section "__DATA,__llvm_prf_data,regular,live_support", align 8
...
@__llvm_prf_nm = private constant [39 x i8] c"\1D%x\DA+\CD+/J,\88\CF/b\CCM\CC\CCc\8C\8FO*\8E/\C9/\88\CFI-K\CD\01\00\A84\0BA", section "__DATA,__llvm_prf_names", align 1
@llvm.compiler.used = appending global [4 x ptr] [ptr @__llvm_profile_runtime_user, ptr @__profd_unwrap_or, ptr @__profd_main, ptr @__profd___bs_top_level], section "llvm.metadata"
...
entry:
  ...
  %pgocount = load i64, ptr @__profc_unwrap_or, align 8
  %2 = add i64 %pgocount, 1
  store i64 %2, ptr @__profc_unwrap_or, align 8
  store ptr %0, ptr %opt, align 8
  store i64 %1, ptr %default, align 8
  %pgocount1 = load i64, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 1), align 8
  %3 = add i64 %pgocount1, 1
  store i64 %3, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 1), align 8
  %pgocount2 = load i64, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 2), align 8
  %4 = add i64 %pgocount2, 1
  store i64 %4, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 2), align 8
  %opt1 = load ptr, ptr %opt, align 8
  %tag_ptr = getelementptr inbounds nuw %Option, ptr %opt1, i32 0, i32 0
...
march_arm:                                        ; preds = %entry
  %pay_slot = getelementptr inbounds nuw %Option, ptr %opt1, i32 0, i32 1
  ...
  %pgocount3 = load i64, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 3), align 8
  %5 = add i64 %pgocount3, 1
  store i64 %5, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 3), align 8
  %pgocount4 = load i64, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 4), align 8
  %6 = add i64 %pgocount4, 1
  store i64 %6, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 4), align 8
  %v3 = load i64, ptr %v2, align 8
  store i64 %v3, ptr %match_result, align 8
  br label %match_end

march_next:                                       ; preds = %entry
  %tag_eq6 = icmp eq i64 %tag, 6384368597
  br i1 %tag_eq6, label %march_arm4, label %march_next5

march_arm4:                                       ; preds = %march_next
  %pgocount5 = load i64, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 5), align 8
  %7 = add i64 %pgocount5, 1
  store i64 %7, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 5), align 8
  %pgocount6 = load i64, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 6), align 8
  %8 = add i64 %pgocount6, 1
  store i64 %8, ptr getelementptr inbounds ([7 x i64], ptr @__profc_unwrap_or, i32 0, i32 6), align 8
...
entry:
  ...
  %tag_ptr = getelementptr inbounds nuw %Option, ptr %3, i32 0, i32 0
  store i64 6384548249, ptr %tag_ptr, align 8
  %pay_ptr = getelementptr inbounds nuw %Option, ptr %3, i32 0, i32 1
  ...
  %5 = add i64 %pgocount3, 1
  store i64 %5, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 3), align 8
  ...
  %6 = add i64 %pgocount4, 1
  store i64 %6, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 4), align 8
  ...
  %tag_ptr2 = getelementptr inbounds nuw %Option, ptr %8, i32 0, i32 0
  store i64 6384368597, ptr %tag_ptr2, align 8
  %pay_ptr3 = getelementptr inbounds nuw %Option, ptr %8, i32 0, i32 1
  ...
  store i64 %9, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 6), align 8
  ...
  store i64 %14, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 11), align 8
  %15 = call i64 @unwrap_or(ptr %a6, i64 0)
  %16 = call ptr @forge_rc_alloc(i64 32)
  %17 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %16, i64 32, ptr @.i2s_fmt, i64 %15)
  %widen = sext i32 %17 to i64
  ...
  store i64 %19, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 12), align 8
  %pgocount13 = load i64, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 13), align 8
  %20 = add i64 %pgocount13, 1
  store i64 %20, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 13), align 8
  %pgocount14 = load i64, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 14), align 8
  %21 = add i64 %pgocount14, 1
  store i64 %21, ptr getelementptr inbounds ([19 x i64], ptr @__profc_main, i32 0, i32 14), align 8
  ...
  %26 = call i64 @unwrap_or(ptr %b8, i64 -1)
  %27 = call ptr @forge_rc_alloc(i64 32)
  %28 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %27, i64 32, ptr @.i2s_fmt.1, i64 %26)
  %widen9 = sext i32 %28 to i64
  %29 = call i32 @puts(ptr %27)
  %widen10 = sext i32 %29 to i64
  ret i64 0
}

define i64 @__bs_top_level() {
entry:
  %pgocount = load i64, ptr getelementptr inbounds ([20 x i64], ptr @__profc___bs_top_level, i32 0, i32 19), align 8
  %0 = add i64 %pgocount, 1
  store i64 %0, ptr getelementptr inbounds ([20 x i64], ptr @__profc___bs_top_level, i32 0, i32 19), align 8
