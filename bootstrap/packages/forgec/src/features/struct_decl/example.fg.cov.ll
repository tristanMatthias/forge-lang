; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.fg.ll'
...
@src_file = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.fg\00", align 1
...
@src_file.3 = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.fg\00", align 1
...
@src_file.7 = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.fg\00", align 1
@fld_name.8 = private unnamed_addr constant [2 x i8] c"y\00", align 1
@sty_name.9 = private unnamed_addr constant [6 x i8] c"Point\00", align 1
@src_file.10 = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.fg\00", align 1
...
entry:
  ...
  store i64 %3, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 2), align 8
  ...
  store i64 %4, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 3), align 8
  ...
  store i64 %13, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 9), align 8
  %pgocount10 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 10), align 8
  %14 = add i64 %pgocount10, 1
  store i64 %14, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 10), align 8
  %pgocount11 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 11), align 8
  %15 = add i64 %pgocount11, 1
  store i64 %15, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 11), align 8
  %pgocount12 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 12), align 8
  %16 = add i64 %pgocount12, 1
  store i64 %16, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 12), align 8
  %pgocount13 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 13), align 8
  %17 = add i64 %pgocount13, 1
  store i64 %17, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 13), align 8
  %p4 = load ptr, ptr @p, align 8
  %cast5 = ptrtoint ptr %p4 to i64
  %null_chk6 = icmp eq i64 %cast5, 0
  %null_ext7 = zext i1 %null_chk6 to i64
  call void @forge_null_deref_trap(ptr @fld_name.1, i64 1, ptr @sty_name.2, i64 5, i64 %null_ext7, ptr @src_file.3, i64 128, i64 10)
  %y_ptr = getelementptr inbounds nuw %Point, ptr %p4, i32 0, i32 1
  %y = load i64, ptr %y_ptr, align 8
  %18 = call ptr @forge_rc_alloc(i64 32)
  %19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %18, i64 32, ptr @.i2s_fmt.4, i64 %y)
  %widen8 = sext i32 %19 to i64
  %20 = call i32 @puts(ptr %18)
  %widen9 = sext i32 %20 to i64
  ...
  store i64 %25, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 18), align 8
  %pgocount19 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 19), align 8
  %26 = add i64 %pgocount19, 1
  store i64 %26, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 19), align 8
  ...
  call void @forge_null_deref_trap(ptr @fld_name.5, i64 1, ptr @sty_name.6, i64 5, i64 %null_ext13, ptr @src_file.7, i64 128, i64 11)
  ...
  store i64 %27, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 20), align 8
  %pgocount21 = load i64, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 21), align 8
  %28 = add i64 %pgocount21, 1
  store i64 %28, ptr getelementptr inbounds ([22 x i64], ptr @__profc_main, i32 0, i32 21), align 8
  ...
  call void @forge_null_deref_trap(ptr @fld_name.8, i64 1, ptr @sty_name.9, i64 5, i64 %null_ext19, ptr @src_file.10, i64 128, i64 11)
  %y_ptr20 = getelementptr inbounds nuw %Point, ptr %p16, i32 0, i32 1
  %y21 = load i64, ptr %y_ptr20, align 8
  %add = add i64 %x15, %y21
  %29 = call ptr @forge_rc_alloc(i64 32)
  %30 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %29, i64 32, ptr @.i2s_fmt.11, i64 %add)
  %widen22 = sext i32 %30 to i64
  %31 = call i32 @puts(ptr %29)
  %widen23 = sext i32 %31 to i64
  %32 = call i32 @forge_test_summary()
  %widen24 = sext i32 %32 to i64
