...
entry:
  ...
  %2 = call i32 @puts(ptr %sub)
  %widen = sext i32 %2 to i64
  %sub4 = load ptr, ptr @sub, align 8
  %3 = call i64 @strlen(ptr %sub4)
  ...
  %7 = call ptr @avra_rc_alloc(i64 4)
  %8 = call ptr @memcpy(ptr %7, ptr inttoptr (i64 add (i64 ptrtoint (ptr @.str.1 to i64), i64 1) to ptr), i64 3)
  ...
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.2, i64 %len)
