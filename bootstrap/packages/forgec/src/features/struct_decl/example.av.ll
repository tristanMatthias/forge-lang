...
@src_file = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.av\00", align 1
...
@src_file.3 = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.av\00", align 1
...
@src_file.7 = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.av\00", align 1
...
@src_file.10 = private unnamed_addr constant [129 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/struct_decl/example.av\00", align 1
...
entry:
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 1, ptr @sty_name, i64 5, i64 %null_ext, ptr @src_file, i64 128, i64 9)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.1, i64 1, ptr @sty_name.2, i64 5, i64 %null_ext7, ptr @src_file.3, i64 128, i64 10)
  %y_ptr = getelementptr inbounds nuw %Point, ptr %p4, i32 0, i32 1
  %y = load i64, ptr %y_ptr, align 8
  %4 = call ptr @avra_rc_alloc(i64 32)
  %5 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %4, i64 32, ptr @.i2s_fmt.4, i64 %y)
  %widen8 = sext i32 %5 to i64
  %6 = call i32 @puts(ptr %4)
  %widen9 = sext i32 %6 to i64
  ...
  call void @avra_null_deref_trap(ptr @fld_name.5, i64 1, ptr @sty_name.6, i64 5, i64 %null_ext13, ptr @src_file.7, i64 128, i64 11)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.8, i64 1, ptr @sty_name.9, i64 5, i64 %null_ext19, ptr @src_file.10, i64 128, i64 11)
  ...
  %8 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %7, i64 32, ptr @.i2s_fmt.11, i64 %add)
  %widen22 = sext i32 %8 to i64
  %9 = call i32 @puts(ptr %7)
  %widen23 = sext i32 %9 to i64
