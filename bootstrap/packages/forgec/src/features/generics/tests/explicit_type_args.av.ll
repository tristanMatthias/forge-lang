...
entry:
  ...
  %2 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %1, i64 32, ptr @.i2s_fmt, i64 %n)
  %widen = sext i32 %2 to i64
  %3 = call i32 @puts(ptr %1)
  %widen1 = sext i32 %3 to i64
  %4 = call ptr @identity__string(ptr @.str)
  store ptr %4, ptr @s, align 8
  %s = load ptr, ptr @s, align 8
  %5 = call i32 @puts(ptr %s)
  ...
  %7 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %6, i64 32, ptr @.i2s_fmt.1, i64 %slt_ext)
  %widen3 = sext i32 %7 to i64
  %8 = call i32 @puts(ptr %6)
  %widen4 = sext i32 %8 to i64
  %9 = call i64 @first__int__string(i64 10, ptr @.str.2)
  store i64 %9, ptr @f, align 8
  %f = load i64, ptr @f, align 8
  %10 = call ptr @avra_rc_alloc(i64 32)
  %11 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %10, i64 32, ptr @.i2s_fmt.3, i64 %f)
  %widen5 = sext i32 %11 to i64
  %12 = call i32 @puts(ptr %10)
  %widen6 = sext i32 %12 to i64
  %13 = call i64 @identity__int(i64 1)
  %add = add i64 %13, 0
  store i64 %add, ptr @sum, align 8
  %sum = load i64, ptr @sum, align 8
  %14 = call ptr @avra_rc_alloc(i64 32)
  %15 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %14, i64 32, ptr @.i2s_fmt.4, i64 %sum)
