; ModuleID = '/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/let_stmt/tests/type_annotations.fg.ll'
...
entry:
  ...
  store i64 %11, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 8), align 8
  %pgocount9 = load i64, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 9), align 8
  %12 = add i64 %pgocount9, 1
  store i64 %12, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 9), align 8
  %pgocount10 = load i64, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 10), align 8
  %13 = add i64 %pgocount10, 1
  store i64 %13, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 10), align 8
  %s = load ptr, ptr @s, align 8
  %14 = call i32 @puts(ptr %s)
  ...
  %b = load i1, ptr @b, align 8
  %19 = call ptr @forge_rc_alloc(i64 32)
  %20 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %19, i64 32, ptr @.i2s_fmt.1, i1 %b)
  %widen3 = sext i32 %20 to i64
  ...
  store i64 %22, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 15), align 8
  %pgocount16 = load i64, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 16), align 8
  %23 = add i64 %pgocount16, 1
  store i64 %23, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 16), align 8
  %pgocount17 = load i64, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 17), align 8
  %24 = add i64 %pgocount17, 1
  store i64 %24, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 17), align 8
  %pgocount18 = load i64, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 18), align 8
  %25 = add i64 %pgocount18, 1
  store i64 %25, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 18), align 8
  %pgocount19 = load i64, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 19), align 8
  %26 = add i64 %pgocount19, 1
  store i64 %26, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 19), align 8
  %p = load i64, ptr @p, align 8
  %nc_null = icmp eq i64 %p, 0
  store i64 %p, ptr %nc_result, align 8
...
nc_rhs:                                           ; preds = %entry
  ...
  store i64 %27, ptr getelementptr inbounds ([21 x i64], ptr @__profc_main, i32 0, i32 20), align 8
...
nc_end:                                           ; preds = %nc_rhs, %entry
  ...
  %29 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %28, i64 32, ptr @.i2s_fmt.2, i64 %nc_val)
  %widen5 = sext i32 %29 to i64
  %30 = call i32 @puts(ptr %28)
  %widen6 = sext i32 %30 to i64
  %31 = call i32 @forge_test_summary()
