...
@src_file = private unnamed_addr constant [141 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/let_stmt/tests/immut_aggressive.av\00", align 1
...
@mu_file = private unnamed_addr constant [141 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/let_stmt/tests/immut_aggressive.av\00", align 1
...
@src_file.12 = private unnamed_addr constant [141 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/let_stmt/tests/immut_aggressive.av\00", align 1
...
@src_file.16 = private unnamed_addr constant [141 x i8] c"/Users/tristan/projects/tristanMatthias/forge-crafting-intepreters/bootstrap/packages/forgec/src/features/let_stmt/tests/immut_aggressive.av\00", align 1
...
for.exit:                                         ; preds = %for.cond
  ...
  call void @avra_null_deref_trap(ptr @fld_name, i64 5, ptr @sty_name, i64 7, i64 %null_ext, ptr @src_file, i64 140, i64 38)
...
forin.exit:                                       ; preds = %forin.cond
  ...
  call void @avra_null_deref_trap(ptr @fld_name.10, i64 1, ptr @sty_name.11, i64 5, i64 %null_ext88, ptr @src_file.12, i64 140, i64 64)
  ...
  call void @avra_null_deref_trap(ptr @fld_name.14, i64 1, ptr @sty_name.15, i64 5, i64 %null_ext94, ptr @src_file.16, i64 140, i64 65)
