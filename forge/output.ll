...
define i64 @Point__sum(ptr %0) {
bb0:
  %1 = load %Point, ptr %0, align 4
  %2 = extractvalue %Point %1, 0
  %3 = load %Point, ptr %0, align 4
  %4 = extractvalue %Point %3, 1
  %5 = add i64 %2, %4
  ret i64 %5
}
...
bb1:
  ...
  store %Point zeroinitializer, ptr %3, align 4
  %4 = getelementptr inbounds %Point, ptr %3, i32 0, i32 0
  store i64 3, ptr %4, align 4
  %5 = getelementptr inbounds %Point, ptr %3, i32 0, i32 1
  store i64 4, ptr %5, align 4
  %6 = load %Point, ptr %3, align 4
  store %Point %6, ptr %2, align 4
  %7 = load %Point, ptr %2, align 4
  %8 = call i64 @Point__sum(%Point %7)
  %9 = call %ForgeString @forge_int_to_string(i64 %8)
  call void @forge_println_string(%ForgeString %9)
  ret i32 0
}
