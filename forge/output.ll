...
entry:
  ...
  %ts = call { ptr, i64 } @forge_int_to_string(i64 %__pt35)
  call void @forge_println_string({ ptr, i64 } %ts)
  %m6 = load i64, ptr %m, align 4
  %str7 = call { ptr, i64 } @forge_string_new(ptr @str.2, i64 1)
  %has = call i8 @forge_map_has(i64 %m6, { ptr, i64 } %str7)
  %has_ext = zext i8 %has to i64
  %__pt4 = alloca i64, align 8
  store i64 %has_ext, ptr %__pt4, align 4
  %__pt48 = load i64, ptr %__pt4, align 4
  %ts9 = call { ptr, i64 } @forge_int_to_string(i64 %__pt48)
  call void @forge_println_string({ ptr, i64 } %ts9)
  %str10 = call { ptr, i64 } @forge_string_new(ptr @str.3, i64 5)
