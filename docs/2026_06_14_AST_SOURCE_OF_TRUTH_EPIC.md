...
| # | Decision | Rationale |
|---|----------|-----------|
| 1 | Collapse to one node type; data-oriented array + side-tables; byte-offset spans | Uniform tree ⇒ clean derivation; substrate for incremental |
...
## 6. Anti-goals — the regrets we refuse to bake in
